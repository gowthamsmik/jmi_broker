    ...
    <section class="about-banner">
        <div class="container">
            <div class="banner-cont text-center mn-hd mn-btn">
                ...
                <a class="theam-btn signUp" href="<?php echo getPageMetaByIDKeyGroup(2,'Banner Button URL 1','Banner');?>">
                ...
                <a class="ol-btn loginUp" href="<?php echo getPageMetaByIDKeyGroup(2,'Banner Button URL 2','Banner');?>"><?php echo getPageMetaByIDKeyGroup(2,'Banner Button Text 2','Banner');?></a>
            </div>
        </div>
    </section>
        ...
        <div class="container pdX5">
            ...
            <div class="aboutSec-bottom">
                <div class="mn-hd mn-btn text-center">
                    ...
                    <!--</p>-->
                    <a class="theam-btn signUp" href="#">Lets Get Started
                        <span>
                            <svg width="21" height="16" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="container pdX5">
            <div class="aboutSec2-top">
                <div class="text-center mn-hd">
                    ...
                    <p class="tx-grey300 p-fs3">Lorem ipsum dolor sit amet consectetur. Elementum risus tempor at <br> vivamus curabitur viverra diam nec.</p>
                </div>
            </div>
            ...
            <div class="pdX5">
                <div class="aboutSec3-top text-center">
                    <div class="mn-hd">
                        ...
                        <p class="p-fs3 tx-white">
                            Lorem ipsum dolor sit amet consectetur. Elementum risus tempor at <br> vivamus curabitur viverra diam nec.
                        </p>
                    </div>
                </div>

...
<div class="app-wrapper">
	...
	<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container-xl">
			...
			<div class="row g-3 mb-4 align-items-center justify-content-between">
				<div class="col-auto">
					<h1 class="app-page-title mb-0">Live Account</h1>
				</div>
				<div class="col-auto">
			...
			<div class="tab-content" id="orders-table-tab-content">
				<div class="tab-pane fade show active" id="orders-all" role="tabpanel" aria-labelledby="orders-all-tab">
							...
							<div class="table-responsive">
								<table class="table app-table-hover mb-0 text-left">
									...
									<tbody>
										...
										$getAllwebsiteaccount = getAllliveaccount($page, $perPage);
					...
					<?php
                    $totalRecords = getTotalliveAccounts();
	...
	<script>
            ...
            //             type: 'post',
            //             data: { type: 'delete-live-accounts', ids: ids, page: currentPage },
            ...
            function deleteRecords(ids) {
                ...
                $.ajax({
                    url: 'includes/softwareinclude/ajax.php',
                    type: 'post',
                    data: { type: 'deletesingleliveaccount', ids: ids },
                    success: function (res) {

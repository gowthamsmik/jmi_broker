    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">			    
			    <h1 class="app-page-title"><?php echo $section_detail['ar_section_name'];?> الفصل</h1>
			    <hr class="mb-4">
				<form class="section-ar-form">
					<input type="hidden" name="section_id" value="<?php echo $pid;?>" />
					<?php $getSectionGroups = getArSectionGroups($pid);
							...
							<div class="col-12 col-md-8">
								<div class="app-card app-card-settings shadow-sm p-4">
									...
									<div class="app-card-body">
										<?php $getSectionFieldsByGroup = getArSectionFieldsByGroup($pid,$thisGroup['group_name']);
					...
					<button type="submit" class="btn app-btn-primary" >حفظ التغييرات</button>
				</form>
		    </div><!--//container-fluid-->
	    </div><!--//app-content-->

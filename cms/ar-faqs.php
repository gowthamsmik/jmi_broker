<div class="app-wrapper">
	...
	<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container-xl">
			...
			<div class="row g-3 mb-4 align-items-center justify-content-between">
				<div class="col-auto">
					<h1 class="app-page-title mb-0">الأسئلة الشائعة باللغة العربية</h1>
				</div>
				<div class="col-auto">
					<a class="" href="add-ar-faq.php">أضف الأسئلة الشائعة</h1></a>
				</div>
				<div class="col-auto">
							...
							<div class="table-responsive">
								<table class="table app-table-hover mb-0 text-left">
									<thead>
										<tr>
											<th class="cell">
												<input type="checkbox" id="selectAllarCheckbox"
													onclick="toggleSelectAll()">
											</th>
                                            <th class="cell">الرقم</th>
                                            <th class="cell">السؤال</th>
                                            <th class="cell">النوع</th>
                                            <th class="cell"></th>
										</tr>
									</thead>
									<tbody>
												...
												<tr>
													...
													<td class="cell">
														<a class="btn-sm app-btn-secondary"
															href="edit-ar-faq.php?id=<?php echo $thisFaq['id']; ?>">تحرير</a>
															<button type="button" class="btn-sm app-btn-secondary"
                                                                onclick="deletarfaq(this);">حذف</button>
													</td>
												</tr>
											<?php }
										} ?>
	...
	<script>
            function deletarfaq() {
                var selectedarRows = document.querySelectorAll('input[name="selectedarRows[]"]:checked');
                ...
                if (confirm('Are you sure you want to delete the selected records?')) {
                    var ids = Array.from(selectedarRows).map(function (row) {
                        return row.value;
                    });
                    ...
                    $.ajax({
                        ...
                        type: 'post',
                        data: { type: 'delete-ar-faq', ids: ids, page: currentPage },
            ...
            function toggleSelectAll() {
                ...
                var selectAllarCheckbox = document.getElementById('selectAllarCheckbox');
                var deleteAllarButton = document.getElementById('deleteAllarButton');

                checkboxes.forEach(function (checkbox) {
                    checkbox.checked = selectAllarCheckbox.checked;
                });

                // Enable or disable the "Delete All" button based on the number of selected checkboxes
                deleteAllarButton.disabled = !checkboxesChecked();
                deleteAllarButton.style = checkboxesChecked() ? 'active' : 'disabled';
            }

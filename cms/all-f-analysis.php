	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    ...
				    <div class="col-auto">
			            <a class="" href="add-f-analysis.php">Add Fundamental Analysis</h1>
				    </div>
				    <div class="col-auto">
						    ...
						    <div class="app-card-body">
							    <div class="table-responsive">
							        <table class="table app-table-hover mb-0 text-left">
										...
										<tbody>
											<?php  $getAllNews = getAllFAnalysis();
											if($getAllNews -> num_rows > 0){
												foreach($getAllNews as $thisNews){ ?>
													<tr>
														...
														<td class="cell">
															<a class="btn-sm app-btn-secondary" href="edit-f-analysis.php?id=<?php echo $thisNews['id'];?>">Edit</a>
														</td>
													</tr>
												<?php }
											} ?>

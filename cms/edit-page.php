    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">			    
			    <h1 class="app-page-title"><?php echo $page_detail['page_name'];?> Page</h1>
			    <hr class="mb-4">
				<form class="settings-form">
					<input type="hidden" name="page_id" value="<?php echo $pid;?>" />
					<?php $getPageGroups = getPageGroups($pid);
							...
							<div class="col-12 col-md-8">
								<div class="app-card app-card-settings shadow-sm p-4">
									...
									<div class="app-card-body">
										<?php $getPageFieldsByGroup = getPageFieldsByGroup($pid,$thisGroup['group_name']);

<div class="app-wrapper">
	...
	<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container-xl">
			...
			<div class="row g-3 mb-4 align-items-center justify-content-between">
				<div class="col-auto">
					<h1 class="app-page-title mb-0">Все русские ЧаВо</h1>
				</div>
				<div class="col-auto">
					<a class="" href="add-ru-faq.php">Добавить ЧаВо</h1></a>
				</div>
				<div class="col-auto">
						...
						<div class="row g-2 justify-content-start justify-content-md-end align-items-center">
							<div class="col">
								<button type="button" class="btn bgcolor my-3" id="deleteAllenfaqButton"
									onclick="deleterufaqs()" style="display: none;">Delete All</button>
							</div>
							<div class="col-auto">
			...
			<!-- <div class="col">
			<button type="button" class="btn bgcolor my-3" id="deleteruButton" onclick="deleterufaqs()"
				...
				<div class="tab-pane fade show active" id="orders-all" role="tabpanel" aria-labelledby="orders-all-tab">
												...
												<tr>
													...
													<td class="cell">
														<a class="btn-sm app-btn-secondary"
															href="edit-ru-faq.php?id=<?php echo $thisFaq['id']; ?>">Изменить</a>
															<button type="button" class="btn-sm app-btn-secondary"
                                                                onclick="deleterufaqs(this);">Удалить</button>
													</td>
												</tr>
											<?php }
										} ?>
					...
					<nav class="app-pagination">
						<ul class="pagination justify-content-end">
							<?php
							$totalRecords = getRuTotalfaqs($searchValue);
	...
	<script>
            function deleterufaqs() {
                ...
                if (confirm('Are you sure you want to delete the selected records?')) {
                    ...
                    $.ajax({
                        ...
                        type: 'post',
                        data: { type: 'delete-ru-faq', ids: ids, page: currentPage },
            ...
            function toggleruSelectAll() {
                ...
                var deleteAllButton = document.getElementById('deleteruButton');
                ...
                deleteAllButton.disabled = !checkboxesruChecked();
                deleteAllButton.style = checkboxesruChecked() ? 'active' : 'disabled';
            }

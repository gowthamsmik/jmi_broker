            ...
            <div class="container-xl">
                ...
                <div class="row g-3 mb-1 align-items-center justify-content-between card">
                    ...
                    <form class="add-offers">
                        ...
                        <input type="text" id="offerarabic_title" name="offerarabic_title" placeholder="Enter name" dir="rtl">
                ...
                <button type="button" class="btn bgcolor my-3" id="deleteAllButton" onclick="deleteoffersanalysis()" style="display: none;">Delete All</button>
                <div class="tab-content" id="orders-table-tab-content">
                    <div class="tab-pane fade show active" id="orders-all" role="tabpanel"
                        ...
                        <div class="app-card app-card-orders-table shadow-sm mb-5">
                                ...
                                <div class="table-responsive">
                                    <table class="table app-table-hover mb-0 text-left">
                                        ...
                                        <tbody>
                                            ...
                                            // echo "page".$page;
                                            $getAllMailListAccount = getAlloffers($page, $perPage);
                                                ...
                                                foreach ($getAllMailListAccount as $mailListAccount) {
                                                    ...
                                                    <tr class="text-center">
                                                        ...
                                                        <td class="cell"><span class="truncate">
                                                            ...
                                                            <td class="cell status-cell" data-status="<?php echo $mailListAccount['offerstatus']; ?>" style="color: #fff; padding: 0px; border-radius: 5px;
                                                                <?php
                                                        ...
                                                        <td class="cell status-cell" data-status="<?php echo $mailListAccount['offertype']; ?>" style="color: #fff; padding: 0px; border-radius: 5px;
                                                                <?php
                                                        ...
                                                        <td class="cell">
                                                        <button type="button" class="btn bgcolor" onclick="viewOffersAnalysis(<?php echo $mailListAccount['id']; ?>,'1')">View</button>
                                                            <button type="button" class="btn bgcolor offerStatus" data-offerStatus="<?php echo $mailListAccount['offerstatus']; ?>" data-id="<?php echo $mailListAccount['id']; ?>">
                                                                <?php $buttonname = ($mailListAccount['offerstatus'] == '0' ? 'published' : 'Unpublished'); ?>
                                                                <?php echo $buttonname; ?>
                                                            </button>


                                                            <button type="button" class="btn bgcolor editoffersButton" data-toggle="modal" data-target="#editoffersPopup" data-id="<?php echo $mailListAccount['id']; ?>">
                                                                Edit
                                                            </button>
                            ...
                            <div class="modal fade " id="editoffersPopup" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <input type="text" id="offerId" name="id">
                                            ...
                                            <label for="arabic_details">Arabic Details</label>
                                            <textarea name="arabic_details" id="offerArabic_details" class="tinymce"></textarea><br />

                                            <label for="title">Russian Title</label>
                                            <input type="text" id="offersrussiantitle" name="russian_title" placeholder="Enter name">
                                            <label for="details">Russian Details</label>
                                            <textarea name="russian_details" id="offersrussiandetails" class="tinymce"></textarea><br />

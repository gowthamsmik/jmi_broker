...
if(isset($_GET['id'])){
	...
	$section_detail = getSectonDetail($pid);
}else{ ?>
    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">			    
			    <h1 class="app-page-title"><?php echo $section_detail['ru_section_name'];?> Раздел</h1>
			    <hr class="mb-4">
				<form class="section-ru-form">
					<input type="hidden" name="section_id" value="<?php echo $pid;?>" />
					<?php $getSectionGroups = getRuSectionGroups($pid);
					if($getSectionGroups->num_rows > 0){
						foreach($getSectionGroups as $thisGroup){ ?>
							...
							<div class="col-12 col-md-8">
								<div class="app-card app-card-settings shadow-sm p-4">
									...
									<div class="app-card-body">
										<?php $getSectionFieldsByGroup = getRuSectionFieldsByGroup($pid,$thisGroup['group_name']);
										if($getSectionFieldsByGroup->num_rows > 0){
											foreach($getSectionFieldsByGroup as $thisField){ ?>
												<div class="mb-3">
					...
					<button type="submit" class="btn app-btn-primary" >Сохранить изменения</button>
				</form>
		    </div><!--//container-fluid-->
	    </div><!--//app-content-->

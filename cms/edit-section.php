    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">			    
			    <h1 class="app-page-title"><?php echo $section_detail['section_name'];?> Section</h1>
			    <hr class="mb-4">
				<form class="section-form">
					<input type="hidden" name="section_id" value="<?php echo $pid;?>" />
					<?php $getSectionGroups = getSectionGroups($pid);
							...
							<div class="col-12 col-md-8">
								<div class="app-card app-card-settings shadow-sm p-4">
									...
									<div class="app-card-body">
										<?php $getSectionFieldsByGroup = getSectionFieldsByGroup($pid,$thisGroup['group_name']);

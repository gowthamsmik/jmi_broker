					...
					<ul class="app-menu list-unstyled accordion" id="menu-accordion">
						...
						<li class="nav-item has-submenu">
							...
							<div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
								<ul class="submenu-list list-unstyled">
									<li class="submenu-item"><a class="submenu-link" href="all-pages.php">All Pages</a>
									</li>
								</ul>
							</div>
						</li><!--//nav-item-->
						<li class="nav-item has-submenu">
							...
							<div id="submenu-2" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
								<ul class="submenu-list list-unstyled">
									<li class="submenu-item"><a class="submenu-link" href="all-sections.php">All
											Sections</a></li>
								</ul>
							</div>
						</li><!--//nav-item-->
						...
						<li class="nav-item has-submenu">
							...
							<div id="submenu-4" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
								<ul class="submenu-list list-unstyled">
									<li class="submenu-item"><a class="submenu-link" href="all-packages.php">All
											Packages</a></li>
								</ul>
							</div>
						</li><!--//nav-item-->
						...
						<li class="nav-item has-submenu">
							...
							<div id="submenu-5" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
								<ul class="submenu-list list-unstyled">
									<li class="submenu-item"><a class="submenu-link" href="all-faqs.php">All FAQ's</a>
									</li>
								</ul>
							</div>
						</li><!--//nav-item-->
						...
						<li class="nav-item has-submenu">
							...
							<div id="submenu-11" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
								<ul class="submenu-list list-unstyled">
									...
									<li class="submenu-item" style="cursor:pointer"><a class="submenu-link openadminpopup" data-toggle="modal"
											data-target="#changepasswordPopup">
											Change Password
										</a></li>
									<li class="submenu-item" style="cursor:pointer"><a class="submenu-link openuserpopup" data-toggle="modal"

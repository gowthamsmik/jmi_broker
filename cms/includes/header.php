...
if (isset($_SESSION['sessionkey'])) {
    ...
    $currentuserid = $_SESSION['sessionuser'];
    global $siteurl;
} else { ?>
		  ...
		  <path fill-rule="evenodd" d="M13 2.5V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
					    ...
					    <li class="nav-item has-submenu">
					        ...
					        <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
						        <ul class="submenu-list list-unstyled">
							        <li class="submenu-item"><a class="submenu-link" href="all-pages.php">All Pages</a></li>
						        </ul>
					        </div>
					    </li><!--//nav-item-->
					    <li class="nav-item has-submenu">
					        ...
					        <div id="submenu-2" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
						        <ul class="submenu-list list-unstyled">
							        <li class="submenu-item"><a class="submenu-link" href="all-sections.php">All Sections</a></li>
						        </ul>
					        </div>
					    </li><!--//nav-item-->
					    ...
					    <li class="nav-item has-submenu">
					        ...
					        <div id="submenu-4" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
						        <ul class="submenu-list list-unstyled">
							        <li class="submenu-item"><a class="submenu-link" href="all-packages.php">All Packages</a></li>
						        </ul>
					        </div>
					    </li><!--//nav-item-->
					    ...
					    <li class="nav-item has-submenu">
					        ...
					        <div id="submenu-5" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
						        <ul class="submenu-list list-unstyled">
							        <li class="submenu-item"><a class="submenu-link" href="all-faqs.php">All FAQ's</a></li>
						        </ul>
					        </div>
					    </li><!--//nav-item-->
					    <li class="nav-item has-submenu">
					        ...
					        <div id="submenu-8" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
						        <ul class="submenu-list list-unstyled">
							        <li class="submenu-item"><a class="submenu-link" href="all-news.php">All News</a></li>
						        </ul>
					        </div>
					    </li><!--//nav-item-->
					    <li class="nav-item has-submenu">
					        ...
					        <div id="submenu-9" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
						        <ul class="submenu-list list-unstyled">
							        <li class="submenu-item"><a class="submenu-link" href="all-f-analysis.php">All Funamental  Analysis</a></li>
						        </ul>
					        </div>
					    </li><!--//nav-item-->
					    <li class="nav-item has-submenu">
					        ...
					        <div id="submenu-6" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
						        <ul class="submenu-list list-unstyled">
							        <li class="submenu-item"><a class="submenu-link" href="all-leads.php">All Leads</a></li>
						        </ul>
					        </div>
					    </li><!--//nav-item-->

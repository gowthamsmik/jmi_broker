...
function getAlldepositerequest($page, $perPage)
{
    global $conn;
    $offset = ($page - 1) * $perPage;
    $sql = "SELECT * FROM transactions WHERE type = '0' LIMIT $offset, $perPage";
    $res = $conn->query($sql);
    return $res;
}
...
function getTotalpageinternalrequest()
{
    ...
    $sql = "SELECT COUNT(*) as total FROM transactions WHERE type = '3'";
    $result = $conn->query($sql);
...
function getAllrefferalaccount($page, $perPage)
{
    global $conn;
    $offset = ($page - 1) * $perPage;
    $sql = "SELECT * FROM website_accounts WHERE account_type = 4 LIMIT $offset, $perPage";
    $res = $conn->query($sql);
    return $res;
}
...
function getAllbecomeourpartner($page, $perPage)
{
    global $conn;
    $offset = ($page - 1) * $perPage;
    $sql = "SELECT * FROM becomepartner LIMIT $offset, $perPage";
    $res = $conn->query($sql);
    return $res;
}

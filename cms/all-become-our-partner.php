    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            ...
            <div class="row g-3 mb-4 align-items-center justify-content-between">
                <div class="col-auto">
                    <h1 class="app-page-title mb-0">All Become Our Partners</h1>
                </div>
                <!-- <div class="col-auto ms-auto">
                    <a class="" href="add-become-our-partner.php">Add Become Our Partners</a>
                </div> -->
                <div class="col-auto">
                                        ...
                                        if ($getAllPackages->num_rows > 0) {
                                            foreach ($getAllPackages as $thisPackage) {
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td class="cell"><span class="truncate">
                                                            <?php echo $thisPackage['email']; ?>
                                                        </span></td>
                                                    <td class="cell"><span class="truncate">
                                                            <?php echo $thisPackage['company']; ?>
                                                        </span></td>
                                                    <td class="cell"><span class="truncate">
                                                            <?php echo $thisPackage['headOfficeLocation']; ?>
                                                        </span></td>
                                                    <td class="cell"><span class="truncate">
                                                            <?php echo $thisPackage['city']; ?>
                                                        </span></td>
                                                    <td class="cell"><span class="truncate">
                                                            <?php echo $thisPackage['phoneno']; ?>
                                                        </span></td>
                                                    <td class="cell">

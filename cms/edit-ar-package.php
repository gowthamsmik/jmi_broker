...
$packageid = $_GET['id'];
$getpackage = getArpackageDetail($packageid);
?>
<div class="app-wrapper">

    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            <h1 class="app-page-title">تحرير الحزمة</h1>
            <hr class="mb-4">
            <form class="update-ar-package">

                <div class="mb-3">
                    <label for="setting-input-1" class="form-label">اسم</label>
                ...
                <div class="mb-3">
                    <label for="setting-input-1" class="form-label">سعر</label>
                    <input name="price" type="number" class="form-control" value="<?php echo $getpackage['price']; ?>">
                </div>
                <div class="mb-3">
                    <label for="setting-input-1" class="form-label">خط العلامة</label>
                ...
                <button type="submit" class="btn app-btn-primary">يحفظ</button>
            </form>
        </div><!--//container-fluid-->
    </div><!--//app-content-->

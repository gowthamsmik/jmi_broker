...
<body>
    ...
    <section class='future-banner' style="background-image: url('cms/<?php echo getPageMetaByIDKeyGroup(34, 'Banner Background', 'Banner'); ?>');">
        <div class='container'>
            <div class='banner-cont text-center mn-hd mn-btn'>
                <h2 class='pdB1'><?php echo getPageMetaByIDKeyGroup(34,'Banner Heading 1','Banner');?></h2>
                <p class='p-fs4 tx-white pdB1'><?php echo getPageMetaByIDKeyGroup(34,'Banner Description','Banner');?></p>
                <a class='gd-btn marR1 signUp' href="<?php echo isset($_SESSION['sessionuser']) ? $demoAccountURL : getPageMetaByIDKeyGroup(34,'Banner Button URL','Banner'); ?>" ><?php echo getPageMetaByIDKeyGroup(34,'Banner Button Text','Banner');?>
                    <span>
                ...
                <div class='row align-items-center'>
                    <div class='col-md-5'>
                        <div class='forexSec1-cont1'>
                            <div class='mn-hd hd-pad'>
                                <h3 class='tx-blue'><?php echo getPageMetaByIDKeyGroup(34,'Heading','Future OTC');?></h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class='col-md-7'>
                        <div class='forexSec1-cont2'>
                            <div class='mn-hd hd-pad'>
                                <p class='p-fs5 tx-grey300'><?php echo getPageMetaByIDKeyGroup(34,'Description','Future OTC');?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class='row'>
                    <div class='col-md-5'>
                        <div class='forexSec1-img'>
                            <img src='cms/<?php echo getPageMetaByIDKeyGroup(34,'Image','Future OTC');?>' alt=''>
                        </div>
                    </div>
                    ...
                    <div class='col-md-7'>
                        <div class='mn-hd'>
                            <p class='p-fs5 tx-grey300 paraPad'>
                                <?php echo getPageMetaByIDKeyGroup(34,'Description 2','Future OTC');?> <br> <br>
                                <?php echo getPageMetaByIDKeyGroup(34,'Description 3','Future OTC');?> <br> <br>
                                <?php echo getPageMetaByIDKeyGroup(34,'Description 4','Future OTC');?> <br> <br>
                                <?php echo getPageMetaByIDKeyGroup(34,'Description 5','Future OTC');?>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class='forex-table-header'>
                    <div class='header-cont mn-hd'>
                        <div class='header-top'>
                            <h5 class='tx-blue'><?php echo getPageMetaByIDKeyGroup(34,'Heading','Crude oil is the raw material');?></h5>
                        </div>
                        <div class='header-main'>
                            <p class='p-fs3 tx-grey300'><?php echo getPageMetaByIDKeyGroup(34,'Description','Crude oil is the raw material');?></p>
                        </div>
                    </div>
                </div>
                ...
                <ul>
                    <li>
                        ...
                        <div class='forexSec4-main-cont'>
                            <div>
                                <h6 class='tx-blue bld'><?php echo getPageMetaByIDKeyGroup(34,'Heading','Example 1');?></h6>
                                <ol>
                                    <?php echo getPageMetaByIDKeyGroup(34,'Description','Example 1');?>
                                </ol>
                                <p><?php echo getPageMetaByIDKeyGroup(34,'Description 2','Example 1');?></p>
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        ...
                        <div class='forexSec4-main-cont'>
                            <div>
                                <h6 class='tx-blue bld'><?php echo getPageMetaByIDKeyGroup(34,'Heading','Example 2');?></h6>
                                <ol>
                                    <?php echo getPageMetaByIDKeyGroup(34,'Description','Example 2');?>
                                </ol>
                                <p><?php echo getPageMetaByIDKeyGroup(34,'Description 2','Example 2');?></p>
                            </div>
                        </div>
                    </li>
                </ul>
                <div class='mn-btn'>
                    <a class='gd-btn marR1 signUp' href="<?php echo isset($_SESSION['sessionuser']) ? $demoAccountURL : getPageMetaByIDKeyGroup(34,'Button URL 1','Bottom Buttons'); ?>" ><?php echo getPageMetaByIDKeyGroup(34,'Button Text 1','Bottom Buttons');?>
                    <span>
                    ...
                    <a class='ol-btn loginUp' href="<?php echo isset($_SESSION['sessionuser']) ? $liveAccountURL : getPageMetaByIDKeyGroup(34,'Button URL 2','Bottom Buttons'); ?>"  ><?php echo getPageMetaByIDKeyGroup(34,'Button Text 2','Bottom Buttons');?></a>
                </div>
            </div>
        </div>
    </section>

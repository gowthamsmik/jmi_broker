    ...
    <section class='future-banner'>
        <div class='container'>
            <div class='banner-cont text-center mn-hd mn-btn'>
                ...
                <a class='gd-btn marR1 signUp' href='<?php echo getPageMetaByIDKeyGroup(34,'Banner Button URL','Banner');?>'><?php echo getPageMetaByIDKeyGroup(34,'Banner Button Text','Banner');?>
                    <span>
    ...
    <section class='forex-section4 pb200'>
        <div class='container'>
            <div class='forexSec4-cont'>
                ...
                <div class='mn-btn'>
                    <a class='gd-btn marR1 signUp' href='<?php echo getPageMetaByIDKeyGroup(34,'Button URL 1','Bottom Buttons');?>'><?php echo getPageMetaByIDKeyGroup(34,'Button Text 1','Bottom Buttons');?>
                    <span>
                    ...
                    <a class='ol-btn loginUp' href='<?php echo getPageMetaByIDKeyGroup(34,'Button URL 2','Bottom Buttons');?>'><?php echo getPageMetaByIDKeyGroup(34,'Button Text 2','Bottom Buttons');?></a>
                </div>
            </div>
        </div>
    </section>

            ...
            <div class="partnerBannner-cont">
               <div class="banner-cont mn-hd mn-btn">
                  ...
                  <div class="banner-btn">
                     <a class="gd-btn signUp" href="<?php echo getPageMetaByIDKeyGroup(11,'Banner Button URL','Banner');?>"><?php echo getPageMetaByIDKeyGroup(11,'Banner Button Text','Banner');?> 
                        <span>
                     ...
                     <a class="ol-btn loginUp" href="<?php echo getPageMetaByIDKeyGroup(11,'Banner Button URL 2','Banner');?>"><?php echo getPageMetaByIDKeyGroup(11,'Banner Button Text 2','Banner');?></a>
                  </div>
               </div>

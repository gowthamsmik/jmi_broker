					...
					<div class="menuWrap">
						<ul class="menu">
							...
							<li class="dropdown-nav">
								...
								<!--<li class="p-0 px-3"><a  class="dropdown-item text-black" href="#"><?php echo $lang['heatmap']; ?></a></li>-->
								<li class="p-0 px-3"><a  class="dropdown-item text-black" href="dailyfundamental.php">
										<?php echo $lang['fundamental_analysis']; ?>
									</a></li>
								<!--<li class="p-0 px-3"><a  class="dropdown-item text-black" href="#"><?php echo $lang['technical_analysis']; ?></a></li>-->

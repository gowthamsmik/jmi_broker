    ...
    <div>
        ...
        <div class="card round p-3 bg-white my-3 py-5">
            ...
            <div class="mt-3 p-1 d-flex justify-content-between">
                <h3>TOTAL VALUE</h3>
                <h3 class="ml-auto font-weight-bold fs-1 text-color">28452<span class="forex-font">.03 USD</span></h3>
            </div>
        </div>
        <div class="card round p-3 bg-white my-3 py-3">
            <div class="mt-2 p-1 d-flex ">
                ...
                <h3 class="text-end ml-auto">28452<span class="forex-font">.03 USD</span><img
                        src="assets/images/svg/ic_moreVertical.svg" alt="404"></h3>
            </div>
        </div>
        <div class="card round p-3 bg-white my-3 py-3">
            <div class="mt-2 p-1 d-flex ">

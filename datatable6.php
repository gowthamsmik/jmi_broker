...
<table id="myTable">
  ...
  <tr id="demo1" class="collapse">
    <td colspan="5">
      ...
      <p> <span>Min/Max Trade size	: </span>0.1/300</p>
      <p> <span>Commission : </span>0.16%</p>
      <p> <span>Trading Hours (GMT+3) : </span>Mon – Fri 10:02 – 14:00, 14:03 – 18:30</p>
  </tr>
  <tr class="search">
    <td>
...
function sortByCol(col) {
  var table, rows, switching, i, x, y, shouldSwitch ,arrows , th;
  table = document.getElementById("myTable");
  ...
  while (switching) {
    ...
    for (i = 0; i < (rows.length - 1); i++) {
      ...
      if(toggle)
      {
        ...
        if (firstX.innerHTML.toLowerCase() > firstY.innerHTML.toLowerCase())
        {

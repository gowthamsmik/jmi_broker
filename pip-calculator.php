    ...
    <section class="pip-banner">
        <div class="container">
            <div class="banner-cont text-center mn-hd mn-btn">
                ...
                <a class="gd-btn marR1 signUp" href="<?php echo getPageMetaByIDKeyGroup(18,'Banner Button URL','Banner');?>"><?php echo getPageMetaByIDKeyGroup(18,'Banner Button Text','Banner');?>
                    <span>

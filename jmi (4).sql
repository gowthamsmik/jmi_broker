...
--
-- Table structure for table `ar_slideshow`
--

CREATE TABLE `ar_slideshow` (
  `id` int(10) UNSIGNED NOT NULL,
  `slide` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `slide_display` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `img` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `a1` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `a1_display` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `a1_link` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `a1_color` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `a1_background` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `a1_fontsize` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `a1_width` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `a1_height` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `a1_top` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `a1_left` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `t` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `t_display` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `t_link` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `t_color` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `t_background` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `t_fontsize` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `t_width` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `t_height` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `t_top` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `t_left` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d1` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d1_display` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d1_link` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d1_color` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d1_background` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d1_fontsize` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d1_width` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d1_height` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d1_top` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d1_left` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d2` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d2_display` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d2_link` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d2_color` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d2_background` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d2_fontsize` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d2_width` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d2_height` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d2_top` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d2_left` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d3` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d3_display` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d3_link` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d3_color` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d3_background` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d3_fontsize` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d3_width` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d3_height` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d3_top` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d3_left` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d4` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d4_display` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d4_link` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d4_color` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d4_background` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d4_fontsize` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d4_width` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d4_height` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d4_top` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d4_left` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d5` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d5_display` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d5_link` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d5_color` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d5_background` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d5_fontsize` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d5_width` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d5_height` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d5_top` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `d5_left` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `btn` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `btn_display` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `btn_link` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `btn_color` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `btn_background` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `btn_fontsize` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `btn_width` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `btn_height` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `btn_top` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `btn_left` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `becomepartner`
--
...
CREATE TABLE `becomepartner` (
  ...
  `headOfficeLocation` varchar(100) NOT NULL,
...
--
-- Dumping data for table `becomepartner`
--

INSERT INTO `becomepartner` (`id`, `title`, `name`, `email`, `company`, `headOfficeLocation`, `city`, `country_code`, `phoneno`, `created_at`, `updated_at`) VALUES
(3, 'Mr', 'buusha', 'gopi.smiksystems@gmail.com', 'jeeva pvt ltd', '2', 'coimbatore', '', 12345678, '2023-12-07 23:00:00', '2023-12-07 23:00:00'),
(5, 'Mr', 'buusha', 'gopi.smiksystems@gmail.com', 'jeeva pvt ltd', '2', 'coimbatore', '', 987654321, '2023-12-09 06:45:32', NULL),
(6, 'Mr', 'buusha', 'asdfsdf', 'jeeva pvt ltd', '1', 'coimbatore', '', 999999999, '2023-12-09 06:47:15', NULL),
(7, 'Mr', 'buusha', 'asdfsdf', 'jeeva pvt ltd', '1', 'coimbatore', '', 9999, '2023-12-09 06:47:26', NULL),
(9, 'Mr', 'buusha', 'gopi.smiksystems@gmail.com', 'gopi pvt ltd', 'Coimbatore', 'coimbatore', '93', 9876543210, '2023-12-10 17:09:17', NULL),
(10, 'Mr', 'gowtham', 'buusha.smiksystems@gmail.com', 'roarer', 'Chennai', 'chennai', '994', 9988774455, '2023-12-11 12:29:59', NULL);
...
CREATE TABLE `callbackrequest` (
  ...
  `timetocall` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `copy_trade`
--
...
CREATE TABLE `copy_trade` (
  ...
  `website_accounts_id` int(11) NOT NULL,
  `status` int(1) NOT NULL,
  `details_admin` text DEFAULT NULL,
  `details_user` text DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `copy_trade`
--

INSERT INTO `copy_trade` (`id`, `copy_from`, `copy_to`, `percentage`, `website_accounts_id`, `status`, `details_admin`, `details_user`, `created_at`, `updated_at`) VALUES
(1, 232335678, 232335678, 11, 1, 8, '', '', '2023-12-10 12:18:19', '2023-12-02 11:26:21'),
(2, 435367353, 435367353, 23, 1, 8, '', '', '2023-12-10 12:18:29', '2023-12-02 11:31:16'),
(3, 232335678, 0, 345, 1, 8, '', '', '2023-12-11 06:20:02', '2023-12-04 11:48:43'),
(4, 232335678, 232335678, 1234, 1, 8, '', '', '2023-12-11 06:20:07', '2023-12-09 15:12:12'),
(5, 435367353, 435367353, 123, 1, 8, '', '', '2023-12-11 06:20:17', '2023-12-09 15:13:21'),
(6, 435367353, 41075134, 12, 1, 8, '', '', '2023-12-11 06:20:25', '2023-12-09 15:13:44'),
(7, 38594849, 232335678, 987, 1, 9, '', '', '2023-12-11 19:39:05', '2023-12-09 15:14:05'),
(8, 41075134, 898968576, 456, 1, 9, '', '', '2023-12-12 05:26:43', '2023-12-09 15:14:25'),
(9, 93701031, 89759412, 22, 1, 8, '', '', '2023-12-11 19:42:22', '2023-12-11 06:19:51');
...
INSERT INTO `currency` (`id`, `currency_name`, `currency_symbol`, `country`, `currency_code`) VALUES
(1, 'US Dollar', '$', 'United States', 'USD'),
(2, 'Euro', '€', 'Eurozone', 'EUR'),
(3, 'Japanese Yen', '¥', 'Japan', 'JPY'),
(4, 'British Pound', '£', 'United Kingdom', 'GBP'),
(5, 'Canadian Dollar', 'CA$', 'Canada', 'CAD'),
(6, 'Swiss Franc', 'CHF', 'Switzerland', 'CHF'),
(7, 'Australian Dollar', 'A$', 'Australia', 'AUD'),
(8, 'Chinese Yuan', '¥', 'China', 'CNY'),
(9, 'Indian Rupee', '₹', 'India', 'INR'),
(10, 'Brazilian Real', 'R$', 'Brazil', 'BRL');
...
INSERT INTO `documents` (`id`, `document`, `description`, `type`, `status`, `website_accounts_id`, `created_at`, `updated_at`) VALUES
(21, '../assets/doc/user_documents/7127601701930128.png', 'vfds', 3, 1, 1, NULL, NULL),
(29, '../assets/doc/user_documents/5312761702188670.jpg', 'robo', 5, 1, 11, '2023-12-10 06:11:10', NULL),
(31, '../assets/doc/user_documents/6775671702193428.jpg', 'bgfd', 2, 2, 11, '2023-12-10 07:30:28', NULL),
(37, '../assets/doc/user_documents/4683991702215053.png', 'kjfku', 1, 1, 9, '2023-12-10 13:30:53', NULL),
(44, '../assets/doc/user_documents/8291531702217448.png', 'sssssssssss', 1, 2, 1, '2023-12-10 14:10:48', NULL);
...
--
-- Dumping data for table `emails_queue`
--

INSERT INTO `emails_queue` (`id`, `email_address`, `queue_id`) VALUES
(1, 'buusha.smiksystems@gmail.com', 1),
(2, 'gopi.smiksystems@gmail.com', 1),
(3, 'gopi.smiksystems@gmail.com', 2);
...
INSERT INTO `email_verification` (`id`, `email`, `token`, `created_at`, `updated_at`) VALUES
(2, 'rlm.muthukumar@gmail.com', '111758', '2023-12-07 07:52:31', '0000-00-00 00:00:00'),
(3, 'gowtham@smiksystem.com', '513960', '2023-12-10 10:59:04', '0000-00-00 00:00:00'),
(4, 'gopi.smiksystems@gmail.com', '677282', '2023-12-10 10:11:57', '0000-00-00 00:00:00'),
(5, 'info@88medias.com', '131872', '2023-12-04 12:40:25', '0000-00-00 00:00:00'),
(6, 'fady.wefky33@gmail.com', '736875', '2023-12-07 11:31:13', '0000-00-00 00:00:00'),
(7, 'buusha.smiksystems@gmail.com', '771629', '2023-12-11 07:52:00', '0000-00-00 00:00:00'),
(8, 'buusha.br@gmail.com', '982217', '2023-12-06 16:32:26', '0000-00-00 00:00:00'),
(9, 'asdfsdaf@g.com', '911331', '2023-12-07 07:52:19', '0000-00-00 00:00:00'),
(10, 'hd3902398@gmail.com', '285038', '2023-12-07 13:59:31', '0000-00-00 00:00:00'),
(11, 'hari.smiksystems@gmail.com', '168409', '2023-12-10 10:17:57', '0000-00-00 00:00:00'),
(12, 'admin@gmail.com', '308867', '2023-12-10 06:24:12', '0000-00-00 00:00:00'),
(13, 'f2a2e204c5@boxmail.lol', '372804', '2023-12-10 08:31:11', '0000-00-00 00:00:00'),
(14, 'charbelassaf44@gmail.com', '244702', '2023-12-10 09:16:13', '0000-00-00 00:00:00'),
(15, 'gopi@gmail.com', '761166', '2023-12-10 09:45:34', '0000-00-00 00:00:00'),
(16, 'gowtham.smiksystems@gmail.com', '683611', '2023-12-10 10:59:33', '0000-00-00 00:00:00'),
(17, 'gowthamsmiksystems@gmail.com', '283964', '2023-12-10 10:21:16', '0000-00-00 00:00:00'),
(18, 'jeeva.smiksystems@gmail.com', '195979', '2023-12-10 12:26:16', '0000-00-00 00:00:00'),
(19, 'kvrgopinath@gmail.com', '152223', '2023-12-11 07:55:26', '0000-00-00 00:00:00'),
(20, 'shokeryfarg@gmail.com', '609352', '2023-12-11 08:24:37', '0000-00-00 00:00:00'),
(21, 'ibrahim@jmibrokers.com', '957731', '2023-12-11 08:27:06', '0000-00-00 00:00:00'),
(22, 'ameer@jmibrokers.com', '429230', '2023-12-11 12:08:12', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `en_slideshow`
--

CREATE TABLE `en_slideshow` (
  `id` int(10) UNSIGNED NOT NULL,
  `slide` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `slide_display` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `img` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `fx_accounts`
--
...
CREATE TABLE `fx_accounts` (
  ...
  `leverage` varchar(6) NOT NULL,
  `account_radio_type` int(1) NOT NULL,
  `password` varchar(60) NOT NULL,
  `investor_password` varchar(60) NOT NULL,
  `status` int(1) NOT NULL,
  `website_accounts_id` int(11) NOT NULL,
...
--
-- Dumping data for table `fx_accounts`
--

INSERT INTO `fx_accounts` (`id`, `account_id`, `account_type`, `account_group`, `currency`, `leverage`, `account_radio_type`, `password`, `investor_password`, `status`, `website_accounts_id`, `created_at`, `updated_at`) VALUES
(40, 93701031, 1, 3, 0, '500', 1, 'grifeGyP', 'EjmhnpVY', 5, 1, NULL, NULL),
(41, 89759412, 1, 1, 1, ' 200 ', 0, ' mjDepFbL ', ' rMCgoqXv ', 5, 1, NULL, '2023-12-11 19:17:10'),
(42, 51356031, 1, 4, 0, '500', 1, 'TbfWlghv', 'nSwFqKMx', 1, 1, NULL, NULL),
(43, 44905525, 3, 2, 0, '500', 1, 'nPmadxkU', 'zRxCVQis', 1, 1, NULL, NULL),
(44, 91824559, 1, 3, 0, '500', 1, 'TYiOwXuj', 'AkOVbyEp', 1, 1, NULL, NULL),
(56, 9112, 1, 1, 1, ' 500 ', 1, ' 0 ', ' jmi123 ', 0, 14, NULL, '2023-12-12 05:28:13'),
(57, 9112, 1, 1, 1, ' 500 ', 1, ' 0 ', ' jmi123 ', 0, 14, NULL, '2023-12-12 05:28:13');
...
INSERT INTO `invoices` (`id`, `user_id`, `fullname`, `account_number`, `amount`, `type`, `filename`, `created_at`, `city`, `country`, `address`, `currency`) VALUES
(19, 1, 'yasir', 435367353, 16, 1, 'invoice_1702031658', '2023-12-08 10:34:18', 'cbe', 'American Samoa', 'fdfvf', '1'),
(20, 14, 'ibrahim', 9112, 100, 1, 'invoice_1702283904', '2023-12-11 08:38:24', 'cairo', 'Aruba', 'gfhjkll', '1');

-- --------------------------------------------------------

--
-- Table structure for table `landingusers`
--

CREATE TABLE `landingusers` (
  `id` int(10) UNSIGNED NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `lname` varchar(300) COLLATE utf8_unicode_ci DEFAULT NULL,
  `email` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `country` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `code` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `phone` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `landing_name` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `cookie` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(2, 'eYdfgGqsioV', 'xuIJeNcoDGQSr', 'holli.landa@outlook.com', 'STJNIiCA', '2023-12-03 23:09:21'),
(3, 'XvQLOwkIRKS', 'huQOWtEdVFnl', 'holli.landa@outlook.com', 'AUWBdeCJQiYcSu', '2023-12-03 23:09:21'),
(4, '', '', '', '', '2023-12-03 23:09:22'),
(5, 'RobertBYCLE', 'RobertBYCLE', 'lucido.leinteract@gmail.com', 'Hai, saya ingin tahu harga Anda.', '2023-12-04 13:45:17'),
(6, 'Charbel', 'Assaf', 'charbelassaf44@gmail.com', 'hello test email', '2023-12-08 08:37:41'),
(7, 'zBPBXIWzORdj', 'zBPBXIWzORdj', 'DohPjr.cwbhtwh@borasca.xyz', 'womIjQJQaoDktvOosa', '2023-12-09 01:55:50'),
(8, 'Hari', 'HAran', 'hari.smiksystems@gmail.com', 'hari', '2023-12-10 11:53:18'),
(9, 'Hari', 'HAran', 'hari.smiksystems@gmail.com', 'hari', '2023-12-10 11:54:42'),
(10, 'Hari', 'HAran', 'hari.smiksystems@gmail.com', 'hari', '2023-12-10 11:55:36'),
(11, 'RobertNaf', 'RobertNaf', 'lucido.leinteract@gmail.com', 'Salam, qiym?tinizi bilm?k ist?dim.', '2023-12-10 12:50:59'),
(12, 'hi', 'hi', 'gabrilla@gmail.com', 'efd', '2023-12-10 16:06:01'),
(13, 'Phildiura', 'Phildiura', 'septon36giannixi@gmail.com', '?????????, ????? ?? ???? ?????? ??.', '2023-12-10 18:37:57'),
(14, 'hi', 'hi', 'gopi.smiksystems@gmail.com', 'huytrew', '2023-12-11 05:44:00'),
(15, 'asfsdfadf', 'asfddfa', 'asfadfs@g.com', 'asdfafsdsa', '2023-12-11 08:10:38'),
(16, 'hi', 'hi', 'gopi.smiksystems@gmail.com', 'wert', '2023-12-11 10:31:00'),
(17, '', '', '', '', '2023-12-11 10:32:21'),
(18, 'gopinath', 'rengharaj', 'gopi.smiksystems@gmail.com', 'hello', '2023-12-11 10:40:39'),
(19, 'gopinath', 'rengharaj', 'gopi.smiksystems@gmail.com', 'hello', '2023-12-11 10:42:14'),
(20, 'VhKkYNLnyc', 'GSKcQRFuDZbANwdi', 'dimapavlova18@outlook.com', 'JnRoPbmLqAiT', '2023-12-11 11:54:51'),
(21, 'BqMvYKPOcACIzENr', 'DgVFsTHayhOXCcx', 'dimapavlova18@outlook.com', 'PXhckzWFjmuqQ', '2023-12-11 11:54:52'),
(22, '', '', '', '', '2023-12-11 11:54:52'),
(23, 'Sky', 'Sky', 'RzJkuM.hcpjhpq@lustrum.cfd', 'Damon Ball', '2023-12-12 01:58:54');
...
INSERT INTO `maillist` (`id`, `mail`, `title`, `name`, `created_at`, `updated_at`) VALUES
(4, 'gopi.smiksystems@gmail.com', 'Mr', 'hari', '2023-12-05 14:49:21', '2023-12-05 14:49:21'),
(5, 'buusha.smiksystems@gmail.com', 'Mr', 'buusha', '2023-12-05 14:49:45', '2023-12-05 14:49:45');
...
CREATE TABLE `notifications` (
  ...
  `notification_ar` varchar(300) DEFAULT NULL,
  `details_ar` text DEFAULT NULL,
  `notification_ru` varchar(300) DEFAULT NULL,
  `details_ru` text DEFAULT NULL,
  `notification_link` varchar(120) DEFAULT NULL,
  `notification_status` int(111) DEFAULT NULL,
  `website_accounts_id` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `notifications` (`id`, `notification`, `details`, `notification_ar`, `details_ar`, `notification_ru`, `details_ru`, `notification_link`, `notification_status`, `website_accounts_id`, `created_at`, `updated_at`) VALUES
(1, 'New live account request from Name=Ragul Buusha - Type= - Group= - User ID=1', NULL, NULL, NULL, NULL, NULL, '#open_account', 0, 999999999, '2023-12-02 04:02:06', NULL),
(2, 'Opening account request processed successfully, you will be notified when it\'s done', 'Opening account request processed successfully, you will be notified when it\'s done', 'تم استلام طلب فتح الحساب بنجاح وسيتم اعلامك عند الأنتهاء', 'تم استلام طلب فتح الحساب بنجاح وسيتم اعلامك عند الأنتهاء', 'Запрос на открытие счета обработан успешно, вы получите уведомление, когда он будет выполнен.', 'Запрос на открытие счета обработан успешно, вы получите уведомление, когда он будет выполнен.', '/cpanel/live-accounts', 0, NULL, '2023-12-02 04:02:06', NULL),
(3, 'Your copy trade request has been received successfully.', 'Your copy trade request has been received successfully.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'Ваш запрос на копирование был успешно получен.', 'Ваш запрос на копирование был успешно получен.', '/cpanel/copy-trade', 0, 1, NULL, NULL),
(4, 'Your copy trade request has been received successfully.', 'Your copy trade request has been received successfully.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'Ваш запрос на копирование был успешно получен.', 'Ваш запрос на копирование был успешно получен.', '/cpanel/copy-trade', 0, 1, NULL, NULL),
(5, 'Successfuly copid the trade', NULL, NULL, NULL, NULL, NULL, '/spanel/copy-trade?&bymail=', 0, 1, NULL, NULL),
(6, '12  New Epay Withdraw', NULL, NULL, NULL, NULL, NULL, '12  New Epay Withdraw', 0, 999999999, '2023-12-04 05:32:15', NULL),
(7, 'Your withdrawal request has been delivered, our backoffice department will handle it soon.', 'Your withdrawal request has been delivered, our backoffice department will handle it soon.', 'تم استلام طلب السحب بنجاح وستتم معالجتة قريبا من جهة الشركة', 'تم استلام طلب السحب بنجاح وستتم معالجتة قريبا من جهة الشركة', 'Ваша заявка на снятие была доставлена, наш бэк-офис скоро обработает ее.', 'Ваша заявка на снятие была доставлена, наш бэк-офис скоро обработает ее.', '/cpanel/transaction-history', 0, 1, '2023-12-04 05:32:15', NULL),
(8, 'New live account request from Name=Ragul Buusha - Type= - Group= - User ID=1', NULL, NULL, NULL, NULL, NULL, '#open_account', 0, 999999999, '2023-12-04 09:30:36', NULL),
(9, 'Opening account request processed successfully, you will be notified when it\'s done', 'Opening account request processed successfully, you will be notified when it\'s done', 'تم استلام طلب فتح الحساب بنجاح وسيتم اعلامك عند الأنتهاء', 'تم استلام طلب فتح الحساب بنجاح وسيتم اعلامك عند الأنتهاء', 'Запрос на открытие счета обработан успешно, вы получите уведомление, когда он будет выполнен.', 'Запрос на открытие счета обработан успешно, вы получите уведомление, когда он будет выполнен.', '/cpanel/live-accounts', 0, NULL, '2023-12-04 09:30:36', NULL),
(10, '12 USD New Epay Deposited ', NULL, NULL, NULL, NULL, NULL, '12 USD New Epay Deposited ', 0, 999999999, '2023-12-04 11:35:11', NULL),
(11, 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', '/cpanel/transaction-history', 0, 1, '2023-12-04 11:35:11', NULL),
(12, 'New live account request from Name=Ragul Buusha - Type= - Group= - User ID=1', NULL, NULL, NULL, NULL, NULL, '#open_account', 0, 999999999, '2023-12-04 11:35:29', NULL),
(13, 'Opening account request processed successfully, you will be notified when it\'s done', 'Opening account request processed successfully, you will be notified when it\'s done', 'تم استلام طلب فتح الحساب بنجاح وسيتم اعلامك عند الأنتهاء', 'تم استلام طلب فتح الحساب بنجاح وسيتم اعلامك عند الأنتهاء', 'Запрос на открытие счета обработан успешно, вы получите уведомление, когда он будет выполнен.', 'Запрос на открытие счета обработан успешно, вы получите уведомление, когда он будет выполнен.', '/cpanel/live-accounts', 0, NULL, '2023-12-04 11:35:29', NULL),
(14, 'New live account request from Name=Ragul Buusha - Type= - Group= - User ID=1', NULL, NULL, NULL, NULL, NULL, '#open_account', 0, 999999999, '2023-12-04 11:36:22', NULL),
(15, 'Opening account request processed successfully, you will be notified when it\'s done', 'Opening account request processed successfully, you will be notified when it\'s done', 'تم استلام طلب فتح الحساب بنجاح وسيتم اعلامك عند الأنتهاء', 'تم استلام طلب فتح الحساب بنجاح وسيتم اعلامك عند الأنتهاء', 'Запрос на открытие счета обработан успешно, вы получите уведомление, когда он будет выполнен.', 'Запрос на открытие счета обработан успешно, вы получите уведомление, когда он будет выполнен.', '/cpanel/live-accounts', 0, NULL, '2023-12-04 11:36:22', NULL),
(16, 'New live account request from Name=Ragul Buusha - Type= - Group= - User ID=1', NULL, NULL, NULL, NULL, NULL, '#open_account', 0, 999999999, '2023-12-04 11:36:43', NULL),
(17, 'Opening account request processed successfully, you will be notified when it\'s done', 'Opening account request processed successfully, you will be notified when it\'s done', 'تم استلام طلب فتح الحساب بنجاح وسيتم اعلامك عند الأنتهاء', 'تم استلام طلب فتح الحساب بنجاح وسيتم اعلامك عند الأنتهاء', 'Запрос на открытие счета обработан успешно, вы получите уведомление, когда он будет выполнен.', 'Запрос на открытие счета обработан успешно, вы получите уведомление, когда он будет выполнен.', '/cpanel/live-accounts', 0, NULL, '2023-12-04 11:36:43', NULL),
(18, 'New live account request from Name=Ragul Buusha - Type= - Group= - User ID=1', NULL, NULL, NULL, NULL, NULL, '#open_account', 0, 999999999, '2023-12-04 11:36:48', NULL),
(19, 'Opening account request processed successfully, you will be notified when it\'s done', 'Opening account request processed successfully, you will be notified when it\'s done', 'تم استلام طلب فتح الحساب بنجاح وسيتم اعلامك عند الأنتهاء', 'تم استلام طلب فتح الحساب بنجاح وسيتم اعلامك عند الأنتهاء', 'Запрос на открытие счета обработан успешно, вы получите уведомление, когда он будет выполнен.', 'Запрос на открытие счета обработан успешно, вы получите уведомление, когда он будет выполнен.', '/cpanel/live-accounts', 0, NULL, '2023-12-04 11:36:48', NULL),
(20, 'buusha.br@gmail.com', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.br@gmail.com', 0, 0, NULL, NULL),
(21, 'Account number rebu228 has been added to your account list successfully', 'Account number rebu228 has been added to your account list successfully', NULL, NULL, NULL, NULL, '/cpanel/live-accounts', 0, 1, NULL, NULL),
(22, '34 USD New Epay Deposited ', NULL, NULL, NULL, NULL, NULL, '34 USD New Epay Deposited ', 0, 999999999, '2023-12-04 11:42:07', NULL),
(23, 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', '/cpanel/transaction-history', 0, 1, '2023-12-04 11:42:07', NULL),
(24, '567 USD New Epay Deposited ', NULL, NULL, NULL, NULL, NULL, '567 USD New Epay Deposited ', 0, 999999999, '2023-12-04 11:43:09', NULL),
(25, 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', '/cpanel/transaction-history', 0, 1, '2023-12-04 11:43:09', NULL),
(26, '4 USD New Epay Deposited ', NULL, NULL, NULL, NULL, NULL, '4 USD New Epay Deposited ', 0, 999999999, '2023-12-04 11:44:07', NULL),
(27, 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', '/cpanel/transaction-history', 0, 1, '2023-12-04 11:44:07', NULL),
(28, 'New live account request from Name=Ragul Buusha - Type= - Group= - User ID=1', NULL, NULL, NULL, NULL, NULL, '#open_account', 0, 999999999, '2023-12-04 11:44:59', NULL),
(29, 'Opening account request processed successfully, you will be notified when it\'s done', 'Opening account request processed successfully, you will be notified when it\'s done', 'تم استلام طلب فتح الحساب بنجاح وسيتم اعلامك عند الأنتهاء', 'تم استلام طلب فتح الحساب بنجاح وسيتم اعلامك عند الأنتهاء', 'Запрос на открытие счета обработан успешно, вы получите уведомление, когда он будет выполнен.', 'Запрос на открытие счета обработан успешно, вы получите уведомление, когда он будет выполнен.', '/cpanel/live-accounts', 0, NULL, '2023-12-04 11:44:59', NULL),
(30, '445 USD New Coinbase Deposited ', NULL, NULL, NULL, NULL, NULL, '445 USD New Coinbase Deposited ', 0, 999999999, '2023-12-04 11:45:23', NULL),
(31, 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', '/cpanel/transaction-history', 0, 1, '2023-12-04 11:45:23', NULL),
(32, '90  New Epay Withdraw', NULL, NULL, NULL, NULL, NULL, '90  New Epay Withdraw', 0, 999999999, '2023-12-04 11:45:58', NULL),
(33, 'Your withdrawal request has been delivered, our backoffice department will handle it soon.', 'Your withdrawal request has been delivered, our backoffice department will handle it soon.', 'تم استلام طلب السحب بنجاح وستتم معالجتة قريبا من جهة الشركة', 'تم استلام طلب السحب بنجاح وستتم معالجتة قريبا من جهة الشركة', 'Ваша заявка на снятие была доставлена, наш бэк-офис скоро обработает ее.', 'Ваша заявка на снятие была доставлена, наш бэк-офис скоро обработает ее.', '/cpanel/transaction-history', 0, 1, '2023-12-04 11:45:58', NULL),
(34, '234  New Epay Withdraw', NULL, NULL, NULL, NULL, NULL, '234  New Epay Withdraw', 0, 999999999, '2023-12-04 11:46:39', NULL),
(35, 'Your withdrawal request has been delivered, our backoffice department will handle it soon.', 'Your withdrawal request has been delivered, our backoffice department will handle it soon.', 'تم استلام طلب السحب بنجاح وستتم معالجتة قريبا من جهة الشركة', 'تم استلام طلب السحب بنجاح وستتم معالجتة قريبا من جهة الشركة', 'Ваша заявка на снятие была доставлена, наш бэк-офис скоро обработает ее.', 'Ваша заявка на снятие была доставлена, наш бэк-офис скоро обработает ее.', '/cpanel/transaction-history', 0, 1, '2023-12-04 11:46:39', NULL),
(36, '4335 USD New CoinBase Withdraw ', NULL, NULL, NULL, NULL, NULL, '4335 USD New CoinBase Withdraw ', 0, 999999999, '2023-12-04 11:47:38', NULL),
(37, 'Your withdrawal request has been delivered, our backoffice department will handle it soon.', 'Your withdrawal request has been delivered, our backoffice department will handle it soon.', 'تم استلام طلب السحب بنجاح وستتم معالجتة قريبا من جهة الشركة', 'تم استلام طلب السحب بنجاح وستتم معالجتة قريبا من جهة الشركة', 'Ваша заявка на снятие была доставлена, наш бэк-офис скоро обработает ее.', 'Ваша заявка на снятие была доставлена, наш бэк-офис скоро обработает ее.', '/cpanel/transaction-history', 0, 1, '2023-12-04 11:47:38', NULL),
(38, 'Your copy trade request has been received successfully.', 'Your copy trade request has been received successfully.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'Ваш запрос на копирование был успешно получен.', 'Ваш запрос на копирование был успешно получен.', '/cpanel/copy-trade', 0, 1, NULL, NULL),
(39, 'Successfuly copid the trade', NULL, NULL, NULL, NULL, NULL, '/spanel/copy-trade?&bymail=', 0, 1, NULL, NULL),
(40, 'buusha.br@gmail.com', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.br@gmail.com', 0, 0, NULL, NULL),
(41, 'Account number we has been added to your account list successfully', 'Account number we has been added to your account list successfully', NULL, NULL, NULL, NULL, '/cpanel/live-accounts', 0, 1, NULL, NULL),
(42, 'New live account request from Name=Ragul Buusha - Type= - Group= - User ID=1', NULL, NULL, NULL, NULL, NULL, '#open_account', 0, 999999999, '2023-12-04 14:00:02', NULL),
(43, 'Opening account request processed successfully, you will be notified when it\'s done', 'Opening account request processed successfully, you will be notified when it\'s done', 'تم استلام طلب فتح الحساب بنجاح وسيتم اعلامك عند الأنتهاء', 'تم استلام طلب فتح الحساب بنجاح وسيتم اعلامك عند الأنتهاء', 'Запрос на открытие счета обработан успешно, вы получите уведомление, когда он будет выполнен.', 'Запрос на открытие счета обработан успешно, вы получите уведомление, когда он будет выполнен.', '/cpanel/live-accounts', 0, NULL, '2023-12-04 14:00:02', NULL),
(44, 'New live account request from Name=Ragul Buusha - Type= - Group= - User ID=1', NULL, NULL, NULL, NULL, NULL, '#open_account', 0, 999999999, '2023-12-04 14:04:31', NULL),
(45, 'Opening account request processed successfully, you will be notified when it\'s done', 'Opening account request processed successfully, you will be notified when it\'s done', 'تم استلام طلب فتح الحساب بنجاح وسيتم اعلامك عند الأنتهاء', 'تم استلام طلب فتح الحساب بنجاح وسيتم اعلامك عند الأنتهاء', 'Запрос на открытие счета обработан успешно, вы получите уведомление, когда он будет выполнен.', 'Запрос на открытие счета обработан успешно, вы получите уведомление, когда он будет выполнен.', '/cpanel/live-accounts', 0, NULL, '2023-12-04 14:04:31', NULL),
(46, 'New live account request from Name=Ragul Buusha - Type= - Group= - User ID=1', NULL, NULL, NULL, NULL, NULL, '#open_account', 0, 999999999, '2023-12-04 14:05:47', NULL),
(47, 'Opening account request processed successfully, you will be notified when it\'s done', 'Opening account request processed successfully, you will be notified when it\'s done', 'تم استلام طلب فتح الحساب بنجاح وسيتم اعلامك عند الأنتهاء', 'تم استلام طلب فتح الحساب بنجاح وسيتم اعلامك عند الأنتهاء', 'Запрос на открытие счета обработан успешно, вы получите уведомление, когда он будет выполнен.', 'Запрос на открытие счета обработан успешно, вы получите уведомление, когда он будет выполнен.', '/cpanel/live-accounts', 0, NULL, '2023-12-04 14:05:47', NULL),
(48, 'buusha.br@gmail.com has created a new demo account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.br@gmail.com&y', 0, 999999999, '2023-12-04 14:07:59', NULL),
(49, 'buusha.br@gmail.com has created a new demo account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.br@gmail.com&y', 0, 999999999, '2023-12-04 14:11:13', NULL),
(50, 'buusha.br@gmail.com has created a new demo account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.br@gmail.com&y', 0, 999999999, '2023-12-04 14:14:03', NULL),
(51, 'buusha.br@gmail.com has created a new demo account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.br@gmail.com&y', 0, 999999999, '2023-12-04 14:39:02', NULL),
(52, 'buusha.br@gmail.com has created a new demo account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.br@gmail.com&y', 0, 999999999, '2023-12-04 14:40:06', NULL),
(53, 'buusha.br@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.br@gmail.com&y', 0, 999999999, '2023-12-04 14:44:18', NULL),
(54, 'buusha.br@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.br@gmail.com&y', 0, 999999999, '2023-12-04 14:51:22', NULL),
(55, 'buusha.br@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.br@gmail.com&y', 0, 999999999, '2023-12-04 14:52:46', NULL),
(56, '233  New Epay Withdraw', NULL, NULL, NULL, NULL, NULL, '233  New Epay Withdraw', 0, 999999999, '2023-12-04 15:06:25', NULL),
(57, 'Your withdrawal request has been delivered, our backoffice department will handle it soon.', 'Your withdrawal request has been delivered, our backoffice department will handle it soon.', 'تم استلام طلب السحب بنجاح وستتم معالجتة قريبا من جهة الشركة', 'تم استلام طلب السحب بنجاح وستتم معالجتة قريبا من جهة الشركة', 'Ваша заявка на снятие была доставлена, наш бэк-офис скоро обработает ее.', 'Ваша заявка на снятие была доставлена, наш бэк-офис скоро обработает ее.', '/cpanel/transaction-history', 0, 1, '2023-12-04 15:06:25', NULL),
(58, '34 USD New Epay Deposited ', NULL, NULL, NULL, NULL, NULL, '34 USD New Epay Deposited ', 0, 999999999, '2023-12-04 15:19:24', NULL),
(59, 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', '/cpanel/transaction-history', 0, 1, '2023-12-04 15:19:24', NULL),
(60, '34 USD New Coinbase Deposited ', NULL, NULL, NULL, NULL, NULL, '34 USD New Coinbase Deposited ', 0, 999999999, '2023-12-04 15:20:02', NULL),
(61, 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', '/cpanel/transaction-history', 0, 1, '2023-12-04 15:20:02', NULL),
(62, '3455  New Epay Withdraw', NULL, NULL, NULL, NULL, NULL, '3455  New Epay Withdraw', 0, 999999999, '2023-12-04 15:20:47', NULL),
(63, 'Your withdrawal request has been delivered, our backoffice department will handle it soon.', 'Your withdrawal request has been delivered, our backoffice department will handle it soon.', 'تم استلام طلب السحب بنجاح وستتم معالجتة قريبا من جهة الشركة', 'تم استلام طلب السحب بنجاح وستتم معالجتة قريبا من جهة الشركة', 'Ваша заявка на снятие была доставлена, наш бэк-офис скоро обработает ее.', 'Ваша заявка на снятие была доставлена, наш бэк-офис скоро обработает ее.', '/cpanel/transaction-history', 0, 1, '2023-12-04 15:20:47', NULL),
(64, '67 USD New CoinBase Withdraw ', NULL, NULL, NULL, NULL, NULL, '67 USD New CoinBase Withdraw ', 0, 999999999, '2023-12-04 15:21:30', NULL),
(65, 'Your withdrawal request has been delivered, our backoffice department will handle it soon.', 'Your withdrawal request has been delivered, our backoffice department will handle it soon.', 'تم استلام طلب السحب بنجاح وستتم معالجتة قريبا من جهة الشركة', 'تم استلام طلب السحب بنجاح وستتم معالجتة قريبا من جهة الشركة', 'Ваша заявка на снятие была доставлена, наш бэк-офис скоро обработает ее.', 'Ваша заявка на снятие была доставлена, наш бэк-офис скоро обработает ее.', '/cpanel/transaction-history', 0, 1, '2023-12-04 15:21:30', NULL),
(66, '3467 USD New CoinBase Withdraw ', NULL, NULL, NULL, NULL, NULL, '3467 USD New CoinBase Withdraw ', 0, 999999999, '2023-12-04 15:22:00', NULL),
(67, 'Your withdrawal request has been delivered, our backoffice department will handle it soon.', 'Your withdrawal request has been delivered, our backoffice department will handle it soon.', 'تم استلام طلب السحب بنجاح وستتم معالجتة قريبا من جهة الشركة', 'تم استلام طلب السحب بنجاح وستتم معالجتة قريبا من جهة الشركة', 'Ваша заявка на снятие была доставлена, наш бэк-офис скоро обработает ее.', 'Ваша заявка на снятие была доставлена, наш бэк-офис скоро обработает ее.', '/cpanel/transaction-history', 0, 1, '2023-12-04 15:22:00', NULL),
(68, 'buusha.br@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.br@gmail.com&y', 0, 999999999, '2023-12-05 05:26:42', NULL),
(69, 'buusha.br@gmail.com', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.br@gmail.com', 0, 0, NULL, NULL),
(70, 'Account number Arafa@123.com has been added to your account list successfully', 'Account number Arafa@123.com has been added to your account list successfully', NULL, NULL, NULL, NULL, '/cpanel/live-accounts', 0, 1, NULL, NULL),
(71, '1200 USD New Epay Deposited ', NULL, NULL, NULL, NULL, NULL, '1200 USD New Epay Deposited ', 0, 999999999, '2023-12-05 05:28:05', NULL),
(72, 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', '/cpanel/transaction-history', 0, 1, '2023-12-05 05:28:05', NULL),
(73, 'buusha.br@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.br@gmail.com&y', 0, 999999999, '2023-12-05 05:41:06', NULL),
(74, 'buusha.br@gmail.com', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.br@gmail.com', 0, 0, NULL, NULL),
(75, 'Account number Denvwr234 has been added to your account list successfully', 'Account number Denvwr234 has been added to your account list successfully', NULL, NULL, NULL, NULL, '/cpanel/live-accounts', 0, 1, NULL, NULL),
(76, '1200 USD New Epay Deposited ', NULL, NULL, NULL, NULL, NULL, '1200 USD New Epay Deposited ', 0, 999999999, '2023-12-05 05:42:11', NULL),
(77, 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', '/cpanel/transaction-history', 0, 1, '2023-12-05 05:42:11', NULL),
(78, '1233 USD New Coinbase Deposited ', NULL, NULL, NULL, NULL, NULL, '1233 USD New Coinbase Deposited ', 0, 999999999, '2023-12-05 05:42:35', NULL),
(79, 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', '/cpanel/transaction-history', 0, 1, '2023-12-05 05:42:35', NULL),
(80, 'buusha.br@gmail.com', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.br@gmail.com', 0, 2147483647, NULL, NULL),
(81, 'Account number 4564352672 has been added to your account list successfully', 'Account number 4564352672 has been added to your account list successfully', NULL, NULL, NULL, NULL, '/cpanel/live-accounts', 0, 1, NULL, NULL),
(82, 'buusha.br@gmail.com', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.br@gmail.com', 0, 2147483647, NULL, NULL),
(83, 'Account number 4564352672 has been added to your account list successfully', 'Account number 4564352672 has been added to your account list successfully', NULL, NULL, NULL, NULL, '/cpanel/live-accounts', 0, 1, NULL, NULL),
(84, 'buusha.br@gmail.com', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.br@gmail.com', 0, 2147483647, NULL, NULL),
(85, 'Account number 4564352672 has been added to your account list successfully', 'Account number 4564352672 has been added to your account list successfully', NULL, NULL, NULL, NULL, '/cpanel/live-accounts', 0, 1, NULL, NULL),
(86, 'buusha.br@gmail.com', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.br@gmail.com', 0, 765422442, NULL, NULL),
(87, 'Account number 765422442 has been added to your account list successfully', 'Account number 765422442 has been added to your account list successfully', NULL, NULL, NULL, NULL, '/cpanel/live-accounts', 0, 1, NULL, NULL),
(88, 'buusha.br@gmail.com', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.br@gmail.com', 0, 45673563, NULL, NULL),
(89, 'Account number 45673563 has been added to your account list successfully', 'Account number 45673563 has been added to your account list successfully', NULL, NULL, NULL, NULL, '/cpanel/live-accounts', 0, 1, NULL, NULL),
(90, 'buusha.br@gmail.com', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.br@gmail.com', 0, 898968576, NULL, NULL),
(91, 'Account number 898968576 has been added to your account list successfully', 'Account number 898968576 has been added to your account list successfully', NULL, NULL, NULL, NULL, '/cpanel/live-accounts', 0, 1, NULL, NULL),
(92, '69 USD New Epay Deposited ', NULL, NULL, NULL, NULL, NULL, '69 USD New Epay Deposited ', 0, 999999999, '2023-12-05 10:04:43', NULL),
(93, 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', '/cpanel/transaction-history', 0, 1, '2023-12-05 10:04:43', NULL),
(94, 'Your document has been deleted successfully.', 'Your document has been deleted successfully.', 'تم حذف المستند الخاص بك بنجاح.', 'تم حذف المستند الخاص بك بنجاح.', 'Ваш документ был успешно удален.', 'Ваш документ был успешно удален.', '/cpanel/documents', 0, 1, '2023-12-05 15:27:39', NULL),
(95, 'Requested invoice and bank details have been sent successfully to your mail,  Please provide your bank with invoice to facilitate your payment.', 'Requested invoice and bank details have been sent successfully to your mail,  Please provide your bank with invoice to facilitate your payment.', 'تم إرسال الفاتورة المطلوبة والتفاصيل المصرفية بنجاح إلى بريدك ، يرجى تزويد البنك الذي تتعامل معه بالفاتورة لتسهيل عملية الدفع.', 'تم إرسال الفاتورة المطلوبة والتفاصيل المصرفية بنجاح إلى بريدك ، يرجى تزويد البنك الذي تتعامل معه بالفاتورة لتسهيل عملية الدفع.', 'Запрошенный счет-фактура и банковские реквизиты были успешно отправлены на вашу почту. Пожалуйста, предоставьте своему банку счет-фактуру, чтобы облегчить вашу оплату.', 'Запрошенный счет-фактура и банковские реквизиты были успешно отправлены на вашу почту. Пожалуйста, предоставьте своему банку счет-фактуру, чтобы облегчить вашу оплату.', '/cpanel/deposit', 0, 1, '2023-12-08 10:12:32', NULL),
(96, 'Requested invoice and bank details have been sent successfully to your mail,  Please provide your bank with invoice to facilitate your payment.', 'Requested invoice and bank details have been sent successfully to your mail,  Please provide your bank with invoice to facilitate your payment.', 'تم إرسال الفاتورة المطلوبة والتفاصيل المصرفية بنجاح إلى بريدك ، يرجى تزويد البنك الذي تتعامل معه بالفاتورة لتسهيل عملية الدفع.', 'تم إرسال الفاتورة المطلوبة والتفاصيل المصرفية بنجاح إلى بريدك ، يرجى تزويد البنك الذي تتعامل معه بالفاتورة لتسهيل عملية الدفع.', 'Запрошенный счет-фактура и банковские реквизиты были успешно отправлены на вашу почту. Пожалуйста, предоставьте своему банку счет-фактуру, чтобы облегчить вашу оплату.', 'Запрошенный счет-фактура и банковские реквизиты были успешно отправлены на вашу почту. Пожалуйста, предоставьте своему банку счет-фактуру, чтобы облегчить вашу оплату.', '/cpanel/deposit', 0, 1, '2023-12-08 10:23:05', NULL),
(97, 'Requested invoice and bank details have been sent successfully to your mail,  Please provide your bank with invoice to facilitate your payment.', 'Requested invoice and bank details have been sent successfully to your mail,  Please provide your bank with invoice to facilitate your payment.', 'تم إرسال الفاتورة المطلوبة والتفاصيل المصرفية بنجاح إلى بريدك ، يرجى تزويد البنك الذي تتعامل معه بالفاتورة لتسهيل عملية الدفع.', 'تم إرسال الفاتورة المطلوبة والتفاصيل المصرفية بنجاح إلى بريدك ، يرجى تزويد البنك الذي تتعامل معه بالفاتورة لتسهيل عملية الدفع.', 'Запрошенный счет-фактура и банковские реквизиты были успешно отправлены на вашу почту. Пожалуйста, предоставьте своему банку счет-фактуру, чтобы облегчить вашу оплату.', 'Запрошенный счет-фактура и банковские реквизиты были успешно отправлены на вашу почту. Пожалуйста, предоставьте своему банку счет-фактуру, чтобы облегчить вашу оплату.', '/cpanel/deposit', 0, 1, '2023-12-08 10:34:18', NULL),
(98, '5 USD New Bank Wire Deposited ', NULL, NULL, NULL, NULL, NULL, '/spanel/deposit-fund-requests?&bymail=buusha.smiksystems@gmail.com&', 0, 999999999, '2023-12-08 17:07:57', NULL),
(99, 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'Your deposit has been delivered successfully, our backoffice department will handle it soon.', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'تم استلام الايداع بنجاح وستتم معالجتة قريبا من جهة الشركة', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', 'Ваш депозит был успешно доставлен, наш бэк-офис скоро его обработает.', '/cpanel/transaction-history', 0, 1, '2023-12-08 17:07:59', NULL),
(100, '16  New Bank Wire Withdraw ', NULL, NULL, NULL, NULL, NULL, '/spanel/withdraw-fund-requests?&bymail=buusha.smiksystems@gmail.com&', 0, 999999999, '2023-12-08 17:10:10', NULL),
(101, 'Your withdrawal request has been delivered, our backoffice department will handle it soon.', 'Your withdrawal request has been delivered, our backoffice department will handle it soon.', 'تم استلام طلب السحب بنجاح وستتم معالجته قريبًا من جهة الشركة', 'تم استلام طلب السحب بنجاح وستتم معالجته قريبًا من جهة الشركة', 'Ваш запрос на снятие был доставлен, наш бэк-офис скоро обработает его.', 'Ваш запрос на снятие был доставлен, наш бэк-офис скоро обработает его.', '/cpanel/transaction-history', 0, 1, '2023-12-08 17:10:11', NULL),
(102, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-09 14:27:26', NULL),
(103, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-09 14:27:26', NULL),
(104, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-09 14:27:53', NULL),
(105, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-09 14:31:12', NULL),
(106, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-09 14:32:51', NULL),
(107, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-09 14:33:21', NULL),
(108, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-09 14:33:50', NULL),
(109, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-09 14:35:48', NULL),
(110, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-09 14:36:07', NULL),
(111, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-09 14:36:25', NULL),
(112, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-09 14:36:58', NULL),
(113, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-09 14:37:45', NULL),
(114, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-09 14:38:07', NULL),
(115, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-09 14:38:52', NULL),
(116, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-09 14:39:16', NULL),
(117, 'Your copy trade request has been received successfully.', 'Your copy trade request has been received successfully.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'Ваш запрос на копирование был успешно получен.', 'Ваш запрос на копирование был успешно получен.', '/cpanel/copy-trade', 0, 1, '2023-12-09 15:12:12', NULL),
(118, 'Successfuly copid the trade', NULL, NULL, NULL, NULL, NULL, '/spanel/copy-trade?&bymail=', 0, 1, '2023-12-09 15:12:12', NULL),
(119, 'Your copy trade request has been received successfully.', 'Your copy trade request has been received successfully.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'Ваш запрос на копирование был успешно получен.', 'Ваш запрос на копирование был успешно получен.', '/cpanel/copy-trade', 0, 1, '2023-12-09 15:13:21', NULL),
(120, 'Successfuly copid the trade', NULL, NULL, NULL, NULL, NULL, '/spanel/copy-trade?&bymail=', 0, 1, '2023-12-09 15:13:21', NULL),
(121, 'Your copy trade request has been received successfully.', 'Your copy trade request has been received successfully.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'Ваш запрос на копирование был успешно получен.', 'Ваш запрос на копирование был успешно получен.', '/cpanel/copy-trade', 0, 1, '2023-12-09 15:13:44', NULL),
(122, 'Successfuly copid the trade', NULL, NULL, NULL, NULL, NULL, '/spanel/copy-trade?&bymail=', 0, 1, '2023-12-09 15:13:44', NULL),
(123, 'Your copy trade request has been received successfully.', 'Your copy trade request has been received successfully.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'Ваш запрос на копирование был успешно получен.', 'Ваш запрос на копирование был успешно получен.', '/cpanel/copy-trade', 0, 1, '2023-12-09 15:14:05', NULL),
(124, 'Successfuly copid the trade', NULL, NULL, NULL, NULL, NULL, '/spanel/copy-trade?&bymail=', 0, 1, '2023-12-09 15:14:05', NULL),
(125, 'Your copy trade request has been received successfully.', 'Your copy trade request has been received successfully.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'Ваш запрос на копирование был успешно получен.', 'Ваш запрос на копирование был успешно получен.', '/cpanel/copy-trade', 0, 1, '2023-12-09 15:14:25', NULL),
(126, 'Successfuly copid the trade', NULL, NULL, NULL, NULL, NULL, '/spanel/copy-trade?&bymail=', 0, 1, '2023-12-09 15:14:25', NULL),
(127, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-10 06:25:43', NULL),
(128, 'Your document has been deleted successfully.', 'Your document has been deleted successfully.', 'تم حذف المستند الخاص بك بنجاح.', 'تم حذف المستند الخاص بك بنجاح.', 'Ваш документ был успешно удален.', 'Ваш документ был успешно удален.', '/cpanel/documents', 0, 11, '2023-12-10 06:28:41', NULL),
(129, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-10 07:05:31', NULL),
(130, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-10 07:05:51', NULL),
(131, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-10 07:06:40', NULL),
(132, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-10 07:06:59', NULL),
(133, 'Your document has been deleted successfully.', 'Your document has been deleted successfully.', 'تم حذف المستند الخاص بك بنجاح.', 'تم حذف المستند الخاص بك بنجاح.', 'Ваш документ был успешно удален.', 'Ваш документ был успешно удален.', '/cpanel/documents', 0, 11, '2023-12-10 07:39:17', NULL),
(134, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-10 08:01:03', NULL),
(135, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-10 08:03:09', NULL),
(136, 'buusha.smiksystems@gmail.com Has Request Account Deleting', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&', 0, 999999999, '2023-12-10 08:06:56', NULL),
(137, 'Account deleting request processed successfully, You will be notified when its done.', 'Account deleting request processed successfully, You will be notified when its done.', 'تمت استلام طلب حذف  الحساب بنجاح ، وسيتم إعلامك عند الانتهاء', 'تمت استلام طلب حذف  الحساب بنجاح ، وسيتم إعلامك عند الانتهاء', 'Запрос на удаление учетной записи успешно обработан, вы получите уведомление, когда это будет сделано.', 'Запрос на удаление учетной записи успешно обработан, вы получите уведомление, когда это будет сделано.', '/cpanel/live-accounts', 0, 1, '2023-12-10 08:06:56', NULL),
(138, 'Live Account Edit Request - Type=IB - leverage=100 - group=Variable Spread - Account_id= - user_id=1 - Login=41', NULL, NULL, NULL, NULL, NULL, '#edit_account', 0, 999999999, '2023-12-10 08:07:45', NULL),
(139, 'Account editing request processed successfully, You will be notified when it\'s done.', 'Account editing request processed successfully, You will be notified when it\'s done.', 'تمت استلام طلب تعديل بيانات الحساب بنجاح ، وسيتم إعلامك عند الانتهاء', 'تمت استلام طلب تعديل بيانات الحساب بنجاح ، وسيتم إعلامك عند الانتهاء', 'Запрос на редактирование учетной записи успешно обработан, вы получите уведомление, когда оно будет выполнено.', 'Запрос на редактирование учетной записи успешно обработан, вы получите уведомление, когда оно будет выполнено.', '/cpanel/live-accounts', 0, 1, '2023-12-10 08:07:45', NULL),
(140, 'Your document has been deleted successfully.', 'Your document has been deleted successfully.', 'تم حذف المستند الخاص بك بنجاح.', 'تم حذف المستند الخاص بك بنجاح.', 'Ваш документ был успешно удален.', 'Ваш документ был успешно удален.', '/cpanel/documents', 0, 1, '2023-12-10 09:10:31', NULL),
(141, 'Your document has been deleted successfully.', 'Your document has been deleted successfully.', 'تم حذف المستند الخاص بك بنجاح.', 'تم حذف المستند الخاص بك بنجاح.', 'Ваш документ был успешно удален.', 'Ваш документ был успешно удален.', '/cpanel/documents', 0, 1, '2023-12-10 09:10:37', NULL),
(142, 'buusha.smiksystems@gmail.com', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com', 0, 345432, '2023-12-10 11:54:20', NULL),
(143, 'Account number 345432 has been added to your account list successfully', 'Account number 345432 has been added to your account list successfully', NULL, NULL, NULL, NULL, '/cpanel/live-accounts', 0, 1, '2023-12-10 11:54:20', NULL),
(144, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-10 12:04:39', NULL),
(145, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-10 12:05:05', NULL),
(146, 'buusha.smiksystems@gmail.com', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com', 0, 0, '2023-12-10 12:06:22', NULL),
(147, 'Account number Hari has been added to your account list successfully', 'Account number Hari has been added to your account list successfully', NULL, NULL, NULL, NULL, '/cpanel/live-accounts', 0, 1, '2023-12-10 12:06:22', NULL),
(148, 'buusha.smiksystems@gmail.com Has Request Account Deleting', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&', 0, 999999999, '2023-12-10 12:08:50', NULL),
(149, 'Account deleting request processed successfully, You will be notified when its done.', 'Account deleting request processed successfully, You will be notified when its done.', 'تمت استلام طلب حذف  الحساب بنجاح ، وسيتم إعلامك عند الانتهاء', 'تمت استلام طلب حذف  الحساب بنجاح ، وسيتم إعلامك عند الانتهاء', 'Запрос на удаление учетной записи успешно обработан, вы получите уведомление, когда это будет сделано.', 'Запрос на удаление учетной записи успешно обработан, вы получите уведомление, когда это будет сделано.', '/cpanel/live-accounts', 0, 1, '2023-12-10 12:08:50', NULL),
(150, 'buusha.smiksystems@gmail.com Has Request Account Deleting', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&', 0, 999999999, '2023-12-10 12:09:31', NULL),
(151, 'Account deleting request processed successfully, You will be notified when its done.', 'Account deleting request processed successfully, You will be notified when its done.', 'تمت استلام طلب حذف  الحساب بنجاح ، وسيتم إعلامك عند الانتهاء', 'تمت استلام طلب حذف  الحساب بنجاح ، وسيتم إعلامك عند الانتهاء', 'Запрос на удаление учетной записи успешно обработан, вы получите уведомление, когда это будет сделано.', 'Запрос на удаление учетной записи успешно обработан, вы получите уведомление, когда это будет сделано.', '/cpanel/live-accounts', 0, 1, '2023-12-10 12:09:31', NULL),
(152, 'buusha.smiksystems@gmail.com Has Request Account Deleting', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&', 0, 999999999, '2023-12-10 12:09:39', NULL),
(153, 'Account deleting request processed successfully, You will be notified when its done.', 'Account deleting request processed successfully, You will be notified when its done.', 'تمت استلام طلب حذف  الحساب بنجاح ، وسيتم إعلامك عند الانتهاء', 'تمت استلام طلب حذف  الحساب بنجاح ، وسيتم إعلامك عند الانتهاء', 'Запрос на удаление учетной записи успешно обработан, вы получите уведомление, когда это будет сделано.', 'Запрос на удаление учетной записи успешно обработан, вы получите уведомление, когда это будет сделано.', '/cpanel/live-accounts', 0, 1, '2023-12-10 12:09:39', NULL),
(154, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-10 12:10:44', NULL),
(155, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-10 12:13:28', NULL),
(156, 'buusha.smiksystems@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=buusha.smiksystems@gmail.com&y', 0, 999999999, '2023-12-10 12:17:36', NULL),
(157, 'Your copy trade deleting request has been received successfully.', 'Your copy trade deleting request has been received successfully.', 'تم استلام طلب حذف نسخ التداول الخاص بك بنجاح.', 'تم استلام طلب حذف نسخ التداول الخاص بك بنجاح.', 'Ваш запрос на удаление копии сделки успешно получен.', 'Ваш запрос на удаление копии сделки успешно получен.', '/cpanel/copy-trade', 0, 1, '2023-12-10 12:18:19', NULL),
(158, 'Your copy trade deleting request has been received successfully.', 'Your copy trade deleting request has been received successfully.', 'تم استلام طلب حذف نسخ التداول الخاص بك بنجاح.', 'تم استلام طلب حذف نسخ التداول الخاص بك بنجاح.', 'Ваш запрос на удаление копии сделки успешно получен.', 'Ваш запрос на удаление копии сделки успешно получен.', '/cpanel/copy-trade', 0, 1, '2023-12-10 12:18:29', NULL),
(159, 'fady.wefky33@gmail.com has created a New Live Account', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=fady.wefky33@gmail.com&y', 0, 999999999, '2023-12-10 13:35:32', NULL),
(160, 'Your document has been deleted successfully.', 'Your document has been deleted successfully.', 'تم حذف المستند الخاص بك بنجاح.', 'تم حذف المستند الخاص بك بنجاح.', 'Ваш документ был успешно удален.', 'Ваш документ был успешно удален.', '/cpanel/documents', 0, 1, '2023-12-10 13:43:33', NULL),
(161, 'Your document has been deleted successfully.', 'Your document has been deleted successfully.', 'تم حذف المستند الخاص بك بنجاح.', 'تم حذف المستند الخاص بك بنجاح.', 'Ваш документ был успешно удален.', 'Ваш документ был успешно удален.', '/cpanel/documents', 0, 1, '2023-12-10 13:43:38', NULL),
(162, 'Your document has been deleted successfully.', 'Your document has been deleted successfully.', 'تم حذف المستند الخاص بك بنجاح.', 'تم حذف المستند الخاص بك بنجاح.', 'Ваш документ был успешно удален.', 'Ваш документ был успешно удален.', '/cpanel/documents', 0, 1, '2023-12-10 13:43:43', NULL),
(163, 'Your document has been deleted successfully.', 'Your document has been deleted successfully.', 'تم حذف المستند الخاص بك بنجاح.', 'تم حذف المستند الخاص بك بنجاح.', 'Ваш документ был успешно удален.', 'Ваш документ был успешно удален.', '/cpanel/documents', 0, 1, '2023-12-10 14:06:36', NULL),
(164, 'Your document has been deleted successfully.', 'Your document has been deleted successfully.', 'تم حذف المستند الخاص بك بنجاح.', 'تم حذف المستند الخاص بك بنجاح.', 'Ваш документ был успешно удален.', 'Ваш документ был успешно удален.', '/cpanel/documents', 0, 1, '2023-12-10 14:06:41', NULL),
(165, 'Your document has been deleted successfully.', 'Your document has been deleted successfully.', 'تم حذف المستند الخاص بك بنجاح.', 'تم حذف المستند الخاص بك بنجاح.', 'Ваш документ был успешно удален.', 'Ваш документ был успешно удален.', '/cpanel/documents', 0, 1, '2023-12-10 14:06:45', NULL),
(166, 'Your document has been deleted successfully.', 'Your document has been deleted successfully.', 'تم حذف المستند الخاص بك بنجاح.', 'تم حذف المستند الخاص بك بنجاح.', 'Ваш документ был успешно удален.', 'Ваш документ был успешно удален.', '/cpanel/documents', 0, 1, '2023-12-10 14:07:15', NULL),
(167, 'Your document has been deleted successfully.', 'Your document has been deleted successfully.', 'تم حذف المستند الخاص بك بنجاح.', 'تم حذف المستند الخاص بك بنجاح.', 'Ваш документ был успешно удален.', 'Ваш документ был успешно удален.', '/cpanel/documents', 0, 1, '2023-12-10 14:07:20', NULL),
(168, 'Your document has been deleted successfully.', 'Your document has been deleted successfully.', 'تم حذف المستند الخاص بك بنجاح.', 'تم حذف المستند الخاص بك بنجاح.', 'Ваш документ был успешно удален.', 'Ваш документ был успешно удален.', '/cpanel/documents', 0, 1, '2023-12-10 14:07:24', NULL),
(169, 'Your copy trade request has been received successfully.', 'Your copy trade request has been received successfully.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'Ваш запрос на копирование был успешно получен.', 'Ваш запрос на копирование был успешно получен.', '/cpanel/copy-trade', 0, 1, '2023-12-11 06:19:51', NULL),
(170, 'Successfuly copid the trade', NULL, NULL, NULL, NULL, NULL, '/spanel/copy-trade?&bymail=', 0, 1, '2023-12-11 06:19:51', NULL);
INSERT INTO `notifications` (`id`, `notification`, `details`, `notification_ar`, `details_ar`, `notification_ru`, `details_ru`, `notification_link`, `notification_status`, `website_accounts_id`, `created_at`, `updated_at`) VALUES
(171, 'Your copy trade deleting request has been received successfully.', 'Your copy trade deleting request has been received successfully.', 'تم استلام طلب حذف نسخ التداول الخاص بك بنجاح.', 'تم استلام طلب حذف نسخ التداول الخاص بك بنجاح.', 'Ваш запрос на удаление копии сделки успешно получен.', 'Ваш запрос на удаление копии сделки успешно получен.', '/cpanel/copy-trade', 0, 1, '2023-12-11 06:20:02', NULL),
(172, 'Your copy trade deleting request has been received successfully.', 'Your copy trade deleting request has been received successfully.', 'تم استلام طلب حذف نسخ التداول الخاص بك بنجاح.', 'تم استلام طلب حذف نسخ التداول الخاص بك بنجاح.', 'Ваш запрос на удаление копии сделки успешно получен.', 'Ваш запрос на удаление копии сделки успешно получен.', '/cpanel/copy-trade', 0, 1, '2023-12-11 06:20:07', NULL),
(173, 'Your copy trade deleting request has been received successfully.', 'Your copy trade deleting request has been received successfully.', 'تم استلام طلب حذف نسخ التداول الخاص بك بنجاح.', 'تم استلام طلب حذف نسخ التداول الخاص بك بنجاح.', 'Ваш запрос на удаление копии сделки успешно получен.', 'Ваш запрос на удаление копии сделки успешно получен.', '/cpanel/copy-trade', 0, 1, '2023-12-11 06:20:17', NULL),
(174, 'Your copy trade deleting request has been received successfully.', 'Your copy trade deleting request has been received successfully.', 'تم استلام طلب حذف نسخ التداول الخاص بك بنجاح.', 'تم استلام طلب حذف نسخ التداول الخاص بك بنجاح.', 'Ваш запрос на удаление копии сделки успешно получен.', 'Ваш запрос на удаление копии сделки успешно получен.', '/cpanel/copy-trade', 0, 1, '2023-12-11 06:20:25', NULL),
(175, 'Your copy trade request has been received successfully.', 'Your copy trade request has been received successfully.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'Ваш запрос на копирование был успешно получен.', 'Ваш запрос на копирование был успешно получен.', '/cpanel/copy-trade', 0, 1, '2023-12-11 06:20:46', NULL),
(176, 'Successfuly copid the trade', NULL, NULL, NULL, NULL, NULL, '/spanel/copy-trade?&bymail=', 0, 1, '2023-12-11 06:20:46', NULL),
(177, 'Your copy trade deleting request has been received successfully.', 'Your copy trade deleting request has been received successfully.', 'تم استلام طلب حذف نسخ التداول الخاص بك بنجاح.', 'تم استلام طلب حذف نسخ التداول الخاص بك بنجاح.', 'Ваш запрос на удаление копии сделки успешно получен.', 'Ваш запрос на удаление копии сделки успешно получен.', '/cpanel/copy-trade', 0, 1, '2023-12-11 06:21:05', NULL),
(178, 'Your copy trade deleting request has been received successfully.', 'Your copy trade deleting request has been received successfully.', 'تم استلام طلب حذف نسخ التداول الخاص بك بنجاح.', 'تم استلام طلب حذف نسخ التداول الخاص بك بنجاح.', 'Ваш запрос на удаление копии сделки успешно получен.', 'Ваш запрос на удаление копии сделки успешно получен.', '/cpanel/copy-trade', 0, 1, '2023-12-11 06:21:15', NULL),
(179, 'Your copy trade deleting request has been received successfully.', 'Your copy trade deleting request has been received successfully.', 'تم استلام طلب حذف نسخ التداول الخاص بك بنجاح.', 'تم استلام طلب حذف نسخ التداول الخاص بك بنجاح.', 'Ваш запрос на удаление копии сделки успешно получен.', 'Ваш запрос на удаление копии сделки успешно получен.', '/cpanel/copy-trade', 0, 1, '2023-12-11 06:21:23', NULL),
(180, 'Your copy trade deleting request has been received successfully.', 'Your copy trade deleting request has been received successfully.', 'تم استلام طلب حذف نسخ التداول الخاص بك بنجاح.', 'تم استلام طلب حذف نسخ التداول الخاص بك بنجاح.', 'Ваш запрос на удаление копии сделки успешно получен.', 'Ваш запрос на удаление копии сделки успешно получен.', '/cpanel/copy-trade', 0, 1, '2023-12-11 06:21:42', NULL),
(181, 'ibrahim@jmibrokers.com', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=ibrahim@jmibrokers.com', 0, 9112, '2023-12-11 08:30:41', NULL),
(182, 'Account number 9112 has been added to your account list successfully', 'Account number 9112 has been added to your account list successfully', NULL, NULL, NULL, NULL, '/cpanel/live-accounts', 0, 14, '2023-12-11 08:30:41', NULL),
(183, 'ibrahim@jmibrokers.com', NULL, NULL, NULL, NULL, NULL, '/spanel/website-accounts?&bymail=ibrahim@jmibrokers.com', 0, 9112, '2023-12-11 08:31:23', NULL),
(184, 'Account number 9112 has been added to your account list successfully', 'Account number 9112 has been added to your account list successfully', NULL, NULL, NULL, NULL, '/cpanel/live-accounts', 0, 14, '2023-12-11 08:31:23', NULL),
(185, 'Requested invoice and bank details have been sent successfully to your mail,  Please provide your bank with invoice to facilitate your payment.', 'Requested invoice and bank details have been sent successfully to your mail,  Please provide your bank with invoice to facilitate your payment.', 'تم إرسال الفاتورة المطلوبة والتفاصيل المصرفية بنجاح إلى بريدك ، يرجى تزويد البنك الذي تتعامل معه بالفاتورة لتسهيل عملية الدفع.', 'تم إرسال الفاتورة المطلوبة والتفاصيل المصرفية بنجاح إلى بريدك ، يرجى تزويد البنك الذي تتعامل معه بالفاتورة لتسهيل عملية الدفع.', 'Запрошенный счет-фактура и банковские реквизиты были успешно отправлены на вашу почту. Пожалуйста, предоставьте своему банку счет-фактуру, чтобы облегчить вашу оплату.', 'Запрошенный счет-фактура и банковские реквизиты были успешно отправлены на вашу почту. Пожалуйста, предоставьте своему банку счет-фактуру, чтобы облегчить вашу оплату.', '/cpanel/deposit', 0, 14, '2023-12-11 08:38:24', NULL),
(186, 'Your document has been deleted successfully.', 'Your document has been deleted successfully.', 'تم حذف المستند الخاص بك بنجاح.', 'تم حذف المستند الخاص بك بنجاح.', 'Ваш документ был успешно удален.', 'Ваш документ был успешно удален.', '/cpanel/documents', 0, 14, '2023-12-11 09:07:30', NULL),
(187, 'Your copy trade request has been received successfully.', 'Your copy trade request has been received successfully.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'تم استلام طلب نسخ التداول الخاص بك بنجاح.', 'Ваш запрос на копирование был успешно получен.', 'Ваш запрос на копирование был успешно получен.', '/cpanel/copy-trade', 0, 14, '2023-12-11 09:08:06', NULL),
(188, 'Successfuly copid the trade', NULL, NULL, NULL, NULL, NULL, '/spanel/copy-trade?&bymail=', 0, 14, '2023-12-11 09:08:06', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `offers_events`
--

CREATE TABLE `offers_events` (
  `id` int(10) UNSIGNED NOT NULL,
  `title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `arabic_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `image` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `details` text COLLATE utf8_unicode_ci NOT NULL,
  `arabic_details` text COLLATE utf8_unicode_ci NOT NULL,
  `russian_title` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `russian_details` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `offertype` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
(2, 'MINIMUM FUNDING', 'Receive even tighter spreads and commissions', 'VARIABLE SPREAD ACCOUNT', '0.1 PIP spread\r\nUp To 1:200 Leverage\r\n500$ Minimum funding\r\nUSD is the main currency\r\nIslamic account - No Swap\r\nMinimum lot 0.01\r\nExpert advisor\r\nHeading is available\r\n5 Digits\r\nScalping is not available', 500.00),
(3, 'MINIMUM FUNDING', 'Benefit from industry-leading entry prices', 'SCALPING ACCOUNT', '1.7 PIP\r\nUp To 1:100 Leverage\r\n1000$ Minimum funding\r\nUSD is the main currency\r\nIslamic account - No Swap\r\nMinimum lot 0.01\r\nExpert advisor\r\nHeading is available\r\n5 Digits\r\nScalping is  available', 1000.00),
(4, 'MINIMUM FUNDING', 'Benefit from industry-leading entry prices', 'BONUS ACCOUNT', '2 PIP fixed spread\r\nUp To 1:500 Leverage\r\n100$ Minimum funding\r\nUSD is the main currency\r\nIslamic account - No Swap\r\nMinimum lot 0.01\r\nExpert advisor\r\nHeading is available\r\n4 Digits\r\nScalping is not available', 100.00);
...
(20, 'Banner Button URL', 'brokers.php', 'text', 1, 'Analytics'),
...
(61, 'Banner Button URL', 'complete-package.php', 'text', 1, 'Package'),
...
(80, 'Read More Link', 'forex-trading.php', 'text', 1, 'Investment Choices Box 1'),
...
(86, 'Read More Link', 'future.php', 'text', 1, 'Investment Choices Box 2'),
...
(92, 'Read More Link', 'commodities.php', 'text', 1, 'Investment Choices Box 3'),
...
(98, 'Read More Link', 'stock-cfds.php', 'text', 1, 'Investment Choices Box 4'),
...
(104, 'Read More Link', 'precious-metal.php', 'text', 1, 'Investment Choices Box 5'),
...
(110, 'Read More Link', 'forex-trading.php', 'text', 1, 'Investment Choices Box 6'),
...
(115, 'Banner Button URL', 'metatrader.php', 'text', 1, 'Statistics'),
(116, 'Packages', '[\"1\",\"2\",\"3\"]', 'list', 1, 'Package'),
(117, 'Banner Background', 'uploads/1702282670_image.jpg', 'file', 2, 'Banner'),
...
(172, 'Banner Background', 'uploads/1702282811_image.jpg', 'file', 3, 'Banner'),
...
(185, 'Banner Background', 'uploads/1702288252_image.jpg', 'file', 5, 'Banner'),
...
(196, 'Banner Background', 'uploads/1702288318_image.jpg', 'file', 6, 'Banner'),
...
(255, 'Ios Link', 'https://apps.apple.com/us/app/metatrader-4/id496212596', 'text', 9, 'Overview'),
(256, 'Android Link', 'https://play.google.com/store/apps/details?id=net.metaquotes.metatrader4&hl=en&refer[…]292009626949028%26server%3dJMIBrokers-Demo%252cJMIBrokers-JMI', 'text', 9, 'Overview'),
...
(266, 'Ios Link', 'https://apps.apple.com/us/app/metatrader-4/id496212596', 'text', 10, 'Overview'),
(267, 'Android Link', 'https://play.google.com/store/apps/details?id=net.metaquotes.metatrader4&hl=en&refer[…]292009626949028%26server%3dJMIBrokers-Demo%252cJMIBrokers-JMI', 'text', 10, 'Overview'),
...
(306, 'Banner Background', 'uploads/1702288455_image.jpg', 'file', 13, 'Banner'),
(307, 'Banner Heading 1', 'Work With Us', 'text', 13, 'Banner'),
(308, 'Banner Button Text', 'Apply For Job', 'text', 13, 'Banner'),
(309, 'Banner Button URL', 'mt4-platform-overview.php', 'text', 13, 'Banner'),
...
(379, 'Banner Background', 'uploads/1702288572_image.jpg', 'file', 17, 'Banner'),
...
(384, 'Banner Background', 'uploads/1702288654_image.jpg', 'file', 18, 'Banner'),
...
(389, 'Banner Background', 'uploads/1702288814_image.png', 'file', 19, 'Banner'),
...
(394, 'Banner Background', 'uploads/1702288895_image.png', 'file', 20, 'Banner'),
...
(400, 'Description', '                                 JMI Brokers employees are passionate about what they do and driven to achieve results. In fact, a recent internal survey showed that 92.3% of employees are proud to work for JMI. In general, job satisfaction, team spirit and passion for work are rated highly by JMI Brokers staff.\r\n                                 <br>\r\n                                 ...\r\n                              ', 'textarea', 13, 'A focus on employees'),
...
(405, 'Description', '                                 As JMI Brokers continues to expand globally, employees can realize career aspirations in a variety of international settings. Outstanding employees who are offered opportunities to represent JMI Brokers abroad can gain valuable knowledge and develop many new competencies which can benefit their future in the Bank....\r\n                              ', 'textarea', 13, 'International career opportunities'),
...
(425, 'Banner Button URL', 'mt4-platform-overview.php', 'text', 21, 'Package'),
(426, 'Banner Background', 'uploads/1702288960_image.jpg', 'file', 22, 'Banner'),
...
(474, 'Banner Background', 'uploads/1702289128_image.jpg', 'file', 24, 'Banner'),
...
(479, 'Banner Background', 'uploads/1702289161_image.jpg', 'file', 25, 'Banner'),
...
(511, 'Banner Background', 'uploads/1702289204_image.jpg', 'file', 26, 'Banner'),
...
(543, 'Banner Background', 'uploads/1702289704_image.jpg', 'file', 27, 'Banner'),
...
(546, 'Banner Background', 'uploads/1702289358_image.jpg', 'file', 28, 'Banner'),
...
(568, 'Banner Background', 'uploads/1702289389_image.jpg', 'file', 29, 'Banner'),
...
(590, 'Banner Background', 'uploads/1702289431_image.jpg', 'file', 30, 'Banner'),
...
(613, 'Banner Background', 'uploads/1702289502_image.jpg', 'file', 31, 'Banner'),
...
(659, 'Banner Background', 'uploads/1702289541_image.jpg', 'file', 32, 'Banner'),
...
(695, 'Banner Background', 'uploads/1702289595_image.jpg', 'file', 33, 'Banner'),
...
(719, 'Banner Background', 'uploads/1702289639_image.jpg', 'file', 34, 'Banner'),
...
(743, 'Banner Background', 'uploads/1695037733_image.jpg', 'file', 35, 'Banner'),
(744, 'Banner Heading 1', 'JMI Brokers | Daily Technical Analysis', 'text', 35, 'Banner'),
(745, 'Banner Button Text', 'DEMO ACCOUNT', 'text', 35, 'Banner'),
(746, 'Banner Button URL', '#', 'text', 35, 'Banner'),
(747, 'Description', 'Daily Technical Analysis', 'textarea', 35, 'Banner'),
(748, 'Banner Background', 'uploads/1695037733_image.jpg', 'file', 36, 'Banner'),
(749, 'Banner Heading 1', 'JMI Brokers | FX HeatMap', 'text', 36, 'Banner'),
(750, 'Banner Button Text', 'DEMO ACCOUNT', 'text', 36, 'Banner'),
(751, 'Banner Button URL', '#', 'text', 36, 'Banner'),
(752, 'Description', 'FX HeatMap', 'textarea', 36, 'Banner'),
(753, 'banner button url', 'mt4-platform-overview.php', 'text', 2, 'about');

-- --------------------------------------------------------

--
-- Table structure for table `referral_statics`
--

CREATE TABLE `referral_statics` (
  `id` int(8) NOT NULL,
...
--
-- Table structure for table `ru_slideshow`
--

CREATE TABLE `ru_slideshow` (
  `id` int(10) UNSIGNED NOT NULL,
  `slide` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `slide_display` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `img` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `search` (
  ...
  `ar_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `send_mail` (
  ...
  `every_second` int(50) NOT NULL,
  `send_count` int(50) NOT NULL,
...
INSERT INTO `send_mail` (`id`, `send_type`, `every_second`, `send_count`, `subject`, `body`, `status`, `created_at`) VALUES
(1, 1, 3, 10, 'JMI Brokers Daily Fundamental Analysis', '<p>hi welcome to jmi brokers</p>', 'queued', '2023-12-08 07:42:18'),
(2, 2, 3, 1, 'JMI Brokers Events', '', 'queued', '2023-12-08 08:30:18');

-- --------------------------------------------------------

--
-- Table structure for table `technicalanalysis`
--
...
CREATE TABLE `technicalanalysis` (
  ...
  `russian_details` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `details` text COLLATE utf8_unicode_ci NOT NULL,
  `technicaltype` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `technicalstatus` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `technicalanalysis`
--

INSERT INTO `technicalanalysis` (`id`, `title`, `arabic_title`, `image`, `arabic_details`, `russian_title`, `russian_details`, `details`, `technicaltype`, `technicalstatus`, `created_at`, `updated_at`) VALUES
(2, 'asdfghjkl', 'qwertyuio', '', 'ertyuio', '3wedrftgyhujiko', '32sd4rftgyhujikolp', 'wertyuiop', '1', '0', '2023-12-05 14:18:17', '2023-12-05 14:18:17');
...
INSERT INTO `transactions` (`id`, `account`, `amount`, `currency`, `type`, `via`, `website_accounts_id`, `status`, `details_admin`, `details_user`, `created_at`, `updated_at`) VALUES
(1, 1, 1200, 'USD', 1, 'paypal', 1, 1, NULL, 'sadfadf  asdf ', '2023-11-28 09:13:36', '0000-00-00 00:00:00'),
(2, 232335678, 12, '1', 1, 'epay', 1, 1, NULL, 'its done', '2023-12-05 14:36:49', '0000-00-00 00:00:00'),
(3, 232335678, 12, '0', 0, 'epay', 1, 0, NULL, NULL, '2023-12-04 11:35:11', '0000-00-00 00:00:00'),
(4, 232335678, 34, '0', 0, 'epay', 1, 0, NULL, NULL, '2023-12-04 11:42:07', '0000-00-00 00:00:00'),
(5, 435367353, 567, '0', 0, 'epay', 1, 0, NULL, NULL, '2023-12-04 11:43:09', '0000-00-00 00:00:00'),
(6, 435367353, 4, '0', 0, 'epay', 1, 0, NULL, NULL, '2023-12-04 11:44:07', '0000-00-00 00:00:00'),
(7, 435367353, 445, '0', 0, 'coinbase', 1, 0, NULL, NULL, '2023-12-04 11:45:23', '0000-00-00 00:00:00'),
(8, 435367353, 90, '1', 1, 'epay', 1, 9, NULL, 'rehecte', '2023-12-05 14:36:57', '0000-00-00 00:00:00'),
(9, 435367353, 234, '1', 1, 'epay', 1, 0, NULL, NULL, '2023-12-04 11:46:39', '0000-00-00 00:00:00'),
(10, 232335678, 4335, '0', 1, 'coinbase', 1, 0, NULL, NULL, '2023-12-04 11:47:38', '0000-00-00 00:00:00'),
(11, 232335678, 345, '1', 2, '435367353', 0, 1, NULL, NULL, '2023-12-04 11:47:59', '0000-00-00 00:00:00'),
(12, 232335678, 233, '1', 1, 'epay', 1, 0, NULL, NULL, '2023-12-04 15:06:25', '0000-00-00 00:00:00'),
(13, 435367353, 34, '0', 0, 'epay', 1, 0, NULL, NULL, '2023-12-04 15:19:24', '0000-00-00 00:00:00'),
(14, 232335678, 34, '0', 0, 'coinbase', 1, 0, NULL, NULL, '2023-12-04 15:20:02', '0000-00-00 00:00:00'),
(15, 38594849, 3455, '1', 1, 'epay', 1, 0, NULL, NULL, '2023-12-04 15:20:47', '0000-00-00 00:00:00'),
(16, 435367353, 67, '0', 1, 'coinbase', 1, 0, NULL, NULL, '2023-12-04 15:21:30', '0000-00-00 00:00:00'),
(17, 38594849, 3467, '0', 1, 'coinbase', 1, 0, NULL, NULL, '2023-12-04 15:22:00', '0000-00-00 00:00:00'),
(18, 435367353, 1200, '0', 0, 'epay', 1, 0, NULL, NULL, '2023-12-05 05:28:05', '0000-00-00 00:00:00'),
(19, 435367353, 1200, '0', 0, 'epay', 1, 0, NULL, NULL, '2023-12-05 05:42:11', '0000-00-00 00:00:00'),
(20, 232335678, 1233, '0', 0, 'coinbase', 1, 0, NULL, NULL, '2023-12-05 05:42:35', '0000-00-00 00:00:00'),
(21, 435367353, 1200, '1', 2, '0', 0, 1, NULL, NULL, '2023-12-05 05:43:05', '0000-00-00 00:00:00'),
(22, 2, 69, '1', 2, '1', 0, 1, NULL, NULL, '2023-12-05 06:21:57', '0000-00-00 00:00:00'),
(23, 232335678, 69, '0', 0, 'epay', 1, 0, NULL, 'test\r\n', '2023-12-11 04:43:55', '0000-00-00 00:00:00'),
(24, 435367353, 5, '1', 0, 'Bank Wire', 0, 1, 'C:\\xampp\\htdocs\\jmi\\cpanel\\includes/../../assets/ttcopy/6105311702055277.png', '', '2023-12-11 04:38:15', '0000-00-00 00:00:00'),
(25, 38594849, 16, '1', 1, 'Bank Wire', 1, 9, 'Bank Name :yoi bankBank Swift :forignBank Account or IBan :s334ddf3445', '', '2023-12-11 04:39:18', '0000-00-00 00:00:00'),
(26, 1, 7, '1', 2, '1', 0, 1, NULL, NULL, '2023-12-09 14:53:51', '0000-00-00 00:00:00'),
(27, 1, 100, '1', 2, '1', 0, 1, NULL, NULL, '2023-12-09 14:54:36', '0000-00-00 00:00:00'),
(28, 2, 123, '1', 2, '1', 0, 1, NULL, NULL, '2023-12-09 14:55:24', '0000-00-00 00:00:00'),
(29, 1, 123, '1', 2, '2', 0, 1, NULL, NULL, '2023-12-09 15:00:55', '0000-00-00 00:00:00'),
(30, 2, 1234, '1', 2, '2', 0, 1, NULL, NULL, '2023-12-09 15:01:32', '0000-00-00 00:00:00'),
(31, 2, 123, '1', 2, '2', 0, 1, NULL, NULL, '2023-12-09 15:01:58', '0000-00-00 00:00:00'),
(32, 2, 123, '1', 2, '2', 0, 1, NULL, NULL, '2023-12-09 15:06:52', '0000-00-00 00:00:00'),
(33, 1, 123, '1', 2, '1', 0, 1, NULL, NULL, '2023-12-09 15:07:53', '0000-00-00 00:00:00'),
(34, 1, 32, '1', 2, '2', 0, 1, NULL, NULL, '2023-12-10 12:16:00', '0000-00-00 00:00:00'),
(35, 1, 345, '1', 2, '2', 0, 1, NULL, NULL, '2023-12-10 12:16:26', '0000-00-00 00:00:00'),
(36, 1, 1, '1', 2, '2', 0, 1, NULL, NULL, '2023-12-10 12:37:30', '0000-00-00 00:00:00');
...
CREATE TABLE `users` (
  ...
  `user_name` varchar(30) CHARACTER SET utf8 DEFAULT 'newuser',
...
INSERT INTO `users` (`id`, `name`, `gender`, `email`, `password`, `user_name`, `user_role`, `is_active`, `phone`) VALUES
(1, 'admin', '1', 'admin@jmi.com', '202cb962ac59075b964b07152d234b70', NULL, 1, 1, NULL),
(41, 'Hertyl', '1', 'usedsr1@gmail.com', 'e71e1903b2218da9def7d2aedc341ae5', 'Adminwdsw', 2, 1, '9494036149'),
(43, 'Supraayan', '1', 'userr@gmail.com', 'e71e1903b2218da9def7d2aedc341ae5', 'Retern1234', 2, 1, '9092490934'),
(44, 'Ragul Buusha', '1', 'buusha@thetransmogrify.in', '6674ca465dcb5b4b95aaa7bbc4d53d0c', 'rebu2228', 2, 1, '9092042198'),
(45, 'Supraayan', '1', 'supraayan@gmail.com', 'b68ec1d73e4c85ecee950c7e4cdaf037', 'supraayn13', 2, 1, '8978909009'),
(46, 'Mackenzie Rodrigo', '1', 'rodrig@gmail.com', '6674ca465dcb5b4b95aaa7bbc4d53d0c', 'Admin', 2, 1, '9092042187');

-- --------------------------------------------------------

--
-- Table structure for table `website_accounts`
--
...
CREATE TABLE `website_accounts` (
  ...
  `town_city` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
  `post_code` bigint(16) DEFAULT NULL,
  `country_code` varchar(11) COLLATE utf8_unicode_ci DEFAULT NULL,
  `home` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mobile` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL,
  `profilePicture` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  `address2` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `address1` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `employment_status` int(3) DEFAULT NULL,
  `nature_of_business` int(3) DEFAULT NULL,
  `annual_income` int(3) DEFAULT NULL,
  `net_worth` int(3) DEFAULT NULL,
  `account_status` int(1) NOT NULL,
  `email_status` int(1) NOT NULL,
  `mobile_status` int(1) NOT NULL,
  `invited_by` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
  `lastactive` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `lastip` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `lastbrowser` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `lastos` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `resettoken` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `resettoken_time` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `website_accounts`
--

INSERT INTO `website_accounts` (`id`, `title`, `fullname`, `username`, `email`, `password`, `gender`, `birthday`, `birthmonth`, `birthyear`, `country`, `town_city`, `post_code`, `country_code`, `home`, `mobile`, `profilePicture`, `address2`, `address1`, `employment_status`, `nature_of_business`, `annual_income`, `net_worth`, `account_status`, `email_status`, `mobile_status`, `invited_by`, `lastactive`, `lastip`, `lastbrowser`, `lastos`, `resettoken`, `resettoken_time`, `created_at`, `updated_at`) VALUES
(1, 1, 'Ragul Buusha', 'rebu2228', 'buusha.smiksystems@gmail.com', '6674ca465dcb5b4b95aaa7bbc4d53d0c', 1, 13, 8, 2015, 'Australia', 'Coimbatore', 641035, '91', '09894036149', '8939423416', 'profile_pic.jpg', 'Marutham nagar, Saravanampatti', 'Door No 202,shree enclave apartments', 3, 4, 4, 6, 1, 1, 1, '', '2023-11-21 12:34:56', '192.168.0.1', NULL, NULL, '613e381735becaaf61139b326260425c', '1702049582', '2023-12-09 15:53:06', '0000-00-00 00:00:00'),
(8, 1, 'asdfasdfadsf', 'asdfsadds', 'rlm2.muthukumar@gmail.com', '3d97abaf54a9c41a8953749d72fc3669', 1, NULL, NULL, NULL, NULL, NULL, NULL, '91', NULL, '343434433', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-12-08 10:20:51', '2023-12-07 07:53:58'),
(9, 1, 'Fady Wefky', 'fady', 'fady.wefky33@gmail.com', '2efd56dc5b1c7f960f8e16b14cb03b8c', 1, 21, 7, 1997, 'Egypt', 'Giza', 12552, '20', '', '01202458823', NULL, 'Haram', 'Omranyah', 1, 1, 1, 1, 1, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-12-10 13:28:42', '2023-12-07 11:31:58'),
(10, 1, 'Hassan darwiche', 'Dr__hsn', 'hd3902398@gmail.com', 'bb7a9a9bfc29090615edba1956d38d13', 1, NULL, NULL, NULL, NULL, NULL, NULL, '961', NULL, '81942838', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-12-07 14:00:21', '2023-12-07 14:00:21'),
(11, 1, 'Hari Haran', 'hari123', 'hari.smiksystems@gmail.com', 'c0cd7988346f98068cf05fa94ef1e546', 1, 13, 4, 2005, 'India', 'Covai', 641045, '91', '9894036149', '9943955953', NULL, 'Coimbatore', 'Saravanampatti', 2, 3, 1, 1, 1, 1, 1, NULL, NULL, NULL, NULL, NULL, '8a5676d029c0d4bee83fcf6fdaba5474', '1702189643', '2023-12-10 06:28:00', '2023-12-10 05:57:56'),
(12, 1, 'Gopi', 'gopi', 'gopi.smiksystems@gmail.com', '35bb657d372a3ac057a45bd5c4e1ab11', 1, NULL, NULL, NULL, NULL, NULL, NULL, '91', NULL, '9585391023', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-12-10 06:32:04', '2023-12-10 06:32:04'),
(13, 1, 'gopi', 'dgggh', 'kvrgopinath@gmail.com', '25d55ad283aa400af464c76d713c07ad', 1, NULL, NULL, NULL, NULL, NULL, NULL, '1268', NULL, '87534566', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, NULL, NULL, NULL, NULL, NULL, '6a63562034a00762cc64bb341e0b7cc9', '1702281518', '2023-12-11 07:59:38', '2023-12-11 07:55:55'),
(14, 1, 'ibrahim', 'ibrahimtest', 'ibrahim@jmibrokers.com', '79651f603943e34d5a5335c3bddbeda9', 1, 17, 6, 1956, 'Andorra', 'ythhj', 123, '20', '11222222', '1202458823', NULL, 'hjjjioppp', 'wjdwr3orwldka', 1, 1, 1, 1, 1, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-12-11 08:34:26', '2023-12-11 08:28:37');
...
--
-- Dumping data for table `website_admins`
--

INSERT INTO `website_admins` (`id`, `name`, `email`, `password`, `roll`, `lastactive`, `lastip`, `lastbrowser`, `lastos`, `resettoken`, `resettoken_time`, `created_at`, `updated_at`) VALUES
(1, 'admin', 'admin@jmi.com', '7afea6d4c9721b014079bfe2ed1dcf93', 1, NULL, NULL, NULL, NULL, NULL, NULL, '2023-12-06 16:39:14', '0000-00-00 00:00:00'),
(3, 'Buusha', 'buusha@gmail.com', '25d55ad283aa400af464c76d713c07ad', 1, NULL, NULL, NULL, NULL, NULL, NULL, '2023-12-11 19:07:48', '0000-00-00 00:00:00');
...
--
-- Indexes for table `ar_slideshow`
--
ALTER TABLE `ar_slideshow`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `slideshow_slide_unique` (`slide`);

--
-- Indexes for table `becomepartner`
--
ALTER TABLE `becomepartner`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `copy_trade`
--
ALTER TABLE `copy_trade`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `en_slideshow`
--
ALTER TABLE `en_slideshow`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `slideshow_slide_unique` (`slide`);
...
--
-- Indexes for table `fx_accounts`
--
ALTER TABLE `fx_accounts`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `landingusers`
--
ALTER TABLE `landingusers`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `maillist`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `maillist_mail_unique` (`mail`);
...
--
-- Indexes for table `offers_events`
--
...
--
-- Indexes for table `referral_statics`
--
ALTER TABLE `referral_statics`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ru_slideshow`
--
ALTER TABLE `ru_slideshow`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `slideshow_slide_unique` (`slide`);
...
--
-- Indexes for table `technicalanalysis`
--
ALTER TABLE `technicalanalysis`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `website_accounts`
--
...
--
-- Indexes for table `website_admins`
--
...
--
-- AUTO_INCREMENT for table `ar_slideshow`
--
ALTER TABLE `ar_slideshow`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `becomepartner`
--
ALTER TABLE `becomepartner`
...
--
-- AUTO_INCREMENT for table `copy_trade`
--
ALTER TABLE `copy_trade`
...
--
-- AUTO_INCREMENT for table `en_slideshow`
--
ALTER TABLE `en_slideshow`
...
--
-- AUTO_INCREMENT for table `fx_accounts`
--
ALTER TABLE `fx_accounts`
...
--
-- AUTO_INCREMENT for table `landingusers`
--
ALTER TABLE `landingusers`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `offers_events`
--
ALTER TABLE `offers_events`
...
--
-- AUTO_INCREMENT for table `referral_statics`
--
ALTER TABLE `referral_statics`
  MODIFY `id` int(8) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ru_slideshow`
--
ALTER TABLE `ru_slideshow`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `technicalanalysis`
--
ALTER TABLE `technicalanalysis`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `website_accounts`
--
ALTER TABLE `website_accounts`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `website_admins`
--
ALTER TABLE `website_admins`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `emails_queue`
  ADD CONSTRAINT `emails_queue_ibfk_1` FOREIGN KEY (`queue_id`) REFERENCES `send_mail` (`id`);
COMMIT;

    ...
    <section class="commodities-banner" style="background-image: url('cms/<?php echo getPageMetaByIDKeyGroup(5, 'Banner Background', 'Banner'); ?>');">
        <div class="container">
            <div class="banner-cont text-center mn-hd mn-btn">
                ...
                <a class="gd-btn marR1 signUp" href="<?php echo isset($_SESSION['sessionuser']) ? $demoAccountURL : '#'; ?>"><?php echo getPageMetaByIDKeyGroup(5,'Banner Button Text','Banner');?> 
                    <span>
                ...
                <a class="ol-btn loginUp" href="<?php echo isset($_SESSION['sessionuser']) ? $liveAccountURL : '#'; ?>"><?php echo getPageMetaByIDKeyGroup(5,'Banner Button Text 2','Banner');?></a>
            </div>
        </div>
    </section>

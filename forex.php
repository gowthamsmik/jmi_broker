    ...
    <section class="forex-banner">
        <div class='container'>
            <div class='banner-cont text-center mn-hd mn-btn'>
                ...
                <p class='p-fs4 tx-white pdB1'><?php echo getPageMetaByIDKeyGroup(31,'Banner Description','Banner');?></p>
                <a class='gd-btn marR1 signUp' href='<?php echo getPageMetaByIDKeyGroup(31,'Banner Button URL','Banner');?>'><?php echo getPageMetaByIDKeyGroup(31,'Banner Button Text','Banner');?>
                    <span>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="forexSec1-cont1">
                            <div class="mn-hd">
                                <h3 class="tx-blue">
                                    <?php echo getPageMetaByIDKeyGroup(31,'Heading','Trade Global');?>
                                </h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="forexSec1-cont2">
                            <div class="mn-hd">
                                <p class="p-fs5 tx-grey300">
                                    <?php echo getPageMetaByIDKeyGroup(31,'Description','Trade Global');?>
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container pdX5">
            <div class="aboutSec2-top">
                <div class="text-center mn-hd">
                    <h3 class="tx-blue"><?php echo getPageMetaByIDKeyGroup(31,'Heading','How It Works');?></h3>
                    <p class="tx-grey300 p-fs3"><?php echo getPageMetaByIDKeyGroup(31,'Description','How It Works');?></p>
                </div>
            </div>
                        ...
                        <div class="main-cont">
                            <div class="mn-hd">
                                <h6 class="tx-grey300">
                                    ...
                                    <?php echo getPageMetaByIDKeyGroup(31,'Heading 1','How It Works');?>
                                </h6>
                                <p class="p-fs5">
                                    <?php echo getPageMetaByIDKeyGroup(31,'Description 1','How It Works');?>
                                </p>
                            </div>
                            ...
                            <div class="mn-hd">
                                <h6 class="tx-grey300">
                                    ...
                                    <?php echo getPageMetaByIDKeyGroup(31,'Heading 2','How It Works');?>
                                </h6>
                                <p class="p-fs5">
                                    <?php echo getPageMetaByIDKeyGroup(31,'Description 2','How It Works');?>
                                </p>
                            </div>
                            ...
                            <div class="mn-hd">
                                <h6 class="tx-grey300">
                                    ...
                                    <?php echo getPageMetaByIDKeyGroup(31,'Heading 3','How It Works');?>
                                </h6>
                                <p class="p-fs5">
                                    <?php echo getPageMetaByIDKeyGroup(31,'Description 3','How It Works');?>
                                </p>
                            </div>
                            ...
                            <div class="mn-hd">
                                <h6 class="tx-grey300">
                                    ...
                                    <?php echo getPageMetaByIDKeyGroup(31,'Heading 4','How It Works');?>
                                </h6>
                                <p class="p-fs5">
                                    <?php echo getPageMetaByIDKeyGroup(31,'Description 4','How It Works');?>
                                </p>
                            </div>
                            ...
                            <div class="mn-hd">
                                <h6 class="tx-grey300">
                                    ...
                                    <?php echo getPageMetaByIDKeyGroup(31,'Heading 5','How It Works');?>
                                </h6>
                                <p class="p-fs5">
                                    <?php echo getPageMetaByIDKeyGroup(31,'Description 5','How It Works');?>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="forex-table-header">
                    <div class="header-cont mn-hd">
                       <div class='header-top'>
                            <h5 class='tx-blue'><?php echo getPageMetaByIDKeyGroup(31,'Heading','Major Currencies');?></h5>
                            <div class="forex-tag">
                        ...
                        <div class='header-main'>
                            <p class='p-fs3 tx-grey300'><?php echo getPageMetaByIDKeyGroup(31,'Description','Major Currencies');?></p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="forex-table">
                <div class="forex-table-header">
                    <div class="header-cont mn-hd">
                        <div class='header-top'>
                            <h5 class='tx-blue'><?php echo getPageMetaByIDKeyGroup(31,'Heading','Major Currencies 1');?></h5>
                        ...
                        <div class='header-main'>
                            <p class='p-fs3 tx-grey300'><?php echo getPageMetaByIDKeyGroup(31,'Description','Major Currencies 1');?></p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="forex-table">
                <div class="forex-table-header">
                    <div class="header-cont mn-hd">
                        <div class='header-top'>
                            <h5 class='tx-blue'><?php echo getPageMetaByIDKeyGroup(31,'Heading','Cross Rates');?></h5>
                        </div>
                        <div class='header-main'>
                            <p class='p-fs3 tx-grey300'><?php echo getPageMetaByIDKeyGroup(31,'Description','Cross Rates');?></p>
                        </div>
                    </div>
                </div>
                ...
                <ul>
                    <li>
                        ...
                        <div class='forexSec4-main-cont'>
                            <div>
                                <h6 class='tx-blue bld'><?php echo getPageMetaByIDKeyGroup(31,'Heading','Example 1');?></h6>
                                <ol>
                                    <?php echo getPageMetaByIDKeyGroup(31,'Description','Example 1');?>
                                </ol>
                                <p><?php echo getPageMetaByIDKeyGroup(31,'Description 2','Example 1');?></p>
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        ...
                        <div class='forexSec4-main-cont'>
                            <div>
                                <h6 class='tx-blue bld'><?php echo getPageMetaByIDKeyGroup(31,'Heading','Example 2');?></h6>
                                <ol>
                                    <?php echo getPageMetaByIDKeyGroup(31,'Description','Example 2');?>
                                </ol>
                                <p><?php echo getPageMetaByIDKeyGroup(31,'Description 2','Example 2');?></p>
                            </div>
                        </div>
                    </li>
                </ul>
                <div class='mn-btn'>
                    <a class='gd-btn marR1 signUp' href='<?php echo getPageMetaByIDKeyGroup(31,'Button URL 1','Bottom Buttons');?>'><?php echo getPageMetaByIDKeyGroup(31,'Button Text 1','Bottom Buttons');?>
                    <span>
                    ...
                    <a class='ol-btn loginUp' href='<?php echo getPageMetaByIDKeyGroup(31,'Button URL 2','Bottom Buttons');?>'><?php echo getPageMetaByIDKeyGroup(31,'Button Text 2','Bottom Buttons');?></a>
                </div>
            </div>
        </div>
    </section>

        ...
        <div class="sidebar">
            ...
            <div class="tab-content mt-2">
               <div class="tab-pane fade show active" id="tab1">
                  ...
                  <a class="d-flex <?php echo trim($uriSegments[3]) == 'copy-trade.php'?'active':'' ?>" href="cpanel/" onclick="showRoute('link9')" id="mylink9"> <img src="../assets/images/sidebar/image8.svg"
                        alt="Link 1 Icon" class="my-1">
                     <h4 class="text-white ms-3 ps-1 mt-2 my_account">Copy Trade</h4>
                  </a>

                  <a class="d-flex <?php echo trim($uriSegments[3]) == 'transaction-history.php'?'active':'' ?>" href="cpanel/transaction-history.php" onclick="showRoute('link10')" id="mylink10"> <img src="../assets/images/sidebar/image10.svg"
                        alt="Link 1 Icon">

...
<?php include("../includes/header.php"); ?>
    ...
    <div class="d-flex">
        <h2 class="fs-4"><?php echo $lang['control_panel_my_referrals']?></h2>
    ...
    <div class="white-box mt-3">
        <h3 style="font-weight: 600; font-size: 25px; line-height: 40px; color: #342E59;"><?php echo $lang['no_referrals_yet']?></h3>

        <div class="input-group mb-3 mt-5">
            <input type="text" class="form-control border rounded" id="MyRef" placeholder="https://www.jmibrokers.net?myref=<?php echo (int) $_SESSION['sessionuser']+10000?>">
            <button class="btn btn-success custom-button rounded-end"   onclick = "copyText()" type="submit">Copy Link</button>

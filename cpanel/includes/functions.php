...
function marketingEmail($mailBody, $mailSubject, $mailTo, $attachment)
{
    try {
        ...
        $marketingMailer->send($marketingMessage);
    } catch (Exception) {
        return '';
    }

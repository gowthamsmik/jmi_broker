...
$htmlContent = '<html style="border: 2px dashed #4f81bd;">
<head>
...
$stmtInsertDocument = $conn->prepare("INSERT INTO documents (website_accounts_id, type, status, description, document) VALUES (:userId, 8, 1, 'Customer Account Agreement', '/assets/user_documents/$newfilename.pdf')");

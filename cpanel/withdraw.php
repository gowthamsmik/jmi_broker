    ...
    <div class='layout'>
        ...
        <div class="content">
            <div class="route-content" id="link1">
                <div class="d-flex">
                    <h2 class="fs-4"><?php echo $lang['withdraw_account']?>
                    </h2>
                            ...
                            <form method="post" action="includes/add_transactions.php?paymentType=epay">
                                ...
                                <div class="col border-0">
                                        ...
                                        <input type="text" class="form-control border rounded-3 mt-2"
                                            placeholder="Your Epay Account No" name="epayAccount" pattern="[0-9]{4,9}" title="Please enter a number with 4 to 9 digits" required>
                                    </div>
                                <div class="row border-0 mt-4">
                                    <div class="col border-0">
                                        <label for="">Amount To Withdraw</label>
                                        <input type="number" class="form-control border rounded-3 mt-2"
                                            placeholder="0" name="epayAmount"  required>
                                    </div>
                                </div>
                            ...
                            <form method="post" action="includes/add_transactions.php?paymentType=coinbase">
                                ...
                                <div class="row border-0 mt-4">
                                    <div class="col border-0">
                                        ...
                                        <input type="text" class="form-control border rounded-3 mt-2"
                                            placeholder="Your Coin Base Account No" name="cbAccount" pattern="[0-9]{4,9}" title="Please enter a number with 4 to 9 digits" required>
                                    </div>
                                </div>
                                <div class="row border-0 mt-4">
                                    <div class="col border-0">
                                        <label for="">Amount To Withdraw</label>
                                        <input type="number" class="form-control border rounded-3 mt-2"
                                            placeholder="0" name="cbAmount" required>
                                    </div>
                                </div>
                                <input type="submit" class="btn btn_color w-50 mt-4 text-white"  value="Withdraw Now"> 

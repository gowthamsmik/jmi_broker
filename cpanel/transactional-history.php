            ...
            <tbody>
                ...
                if (is_array($transactionArray)&& count($transactionArray)>0) {
                    foreach ($transactionArray as $data) {
                        echo "<tr>";
                        echo "<td class='align-middle text-center'><div  class=' m-2 serial py-1 px-2'>" . htmlspecialchars($data['id']) . "</div></td>";
                        ...
                        if($data['status'] == '1')
                                    { 
                        echo "<td class='align-middle'><div class='status1 m-2 py-2 px-2 rounded text-center'>" . htmlspecialchars('Success') . "</td>";
			            } 
                        elseif ($data['status'] == '0')
                        {
                            echo "<td class='align-middle'><div class='status2 m-2 py-2 px-2 rounded'>" . htmlspecialchars('Pending') . "</td>";
                        }
                        else
                        {
                            echo "<td class='align-middle'><div class='status3 m-2 py-2 px-2 rounded'>" . htmlspecialchars('Rejected') . "</td>";

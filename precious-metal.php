    ...
    <section class='precious-banner'>
        <div class='container'>
            <div class='banner-cont text-center mn-hd mn-btn'>
                ...
                <p class='p-fs4 tx-white pdB1'><?php echo getPageMetaByIDKeyGroup(30,'Banner Description','Banner');?></p>
                <a class='gd-btn marR1 signUp' href='<?php echo getPageMetaByIDKeyGroup(30,'Banner Button URL','Banner');?>'><?php echo getPageMetaByIDKeyGroup(30,'Banner Button Text','Banner');?>
                    <span>
    ...
    <section class='forex-section1'>
        <div class='container'>
            <div class='pdX5'>
                <div class='row align-items-center'>
                    <div class='col-md-5'>
                        <div class='forexSec1-cont1'>
                            <div class='mn-hd hd-pad'>
                                <h3 class='tx-blue'>
                                    <?php echo getPageMetaByIDKeyGroup(30,'Heading','Spot Precious Metals');?>
                                </h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class='col-md-7'>
                        <div class='forexSec1-cont2'>
                            <div class='mn-hd hd-pad'>
                                <p class='p-fs5 tx-grey300'><?php echo getPageMetaByIDKeyGroup(30,'Description','Spot Precious Metals');?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class='row align-items-center'>
                    <div class='col-md-5'>
                        <div class='forexSec1-img hello'>
                            <img src='cms/<?php echo getPageMetaByIDKeyGroup(30,'Image','Spot Precious Metals');?>' alt=''>
                        </div>
                    </div>

                    <div class='col-md-7'>
                        <div class='mn-hd'>
                            <p class='p-fs5 tx-grey300 paraPad'><?php echo getPageMetaByIDKeyGroup(30,'Description 2','Spot Precious Metals');?></p>
                            <p class='p-fs5 tx-grey300 bld'><?php echo getPageMetaByIDKeyGroup(30,'Description 3','Spot Precious Metals');?></p>
                            <ul class='list100'>
                                <?php echo getPageMetaByIDKeyGroup(30,'Description 4','Spot Precious Metals');?>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class='forex-table-header'>
                    <div class='header-cont mn-hd'>
                        ...
                        <div class='header-main'>
                            <p class='p-fs3 tx-grey300'><?php echo getPageMetaByIDKeyGroup(30,'Description','Major Currencies');?></p>
                        </div>
                    </div>
                </div>
                ...
                <ul>
                    <li>
                        ...
                        <div class='forexSec4-main-cont'>
                            <div>
                                <h6 class='tx-blue bld'><?php echo getPageMetaByIDKeyGroup(30,'Heading','Example 1');?></h6>
                                <ol>
                                    <?php echo getPageMetaByIDKeyGroup(30,'Description','Example 1');?>
                                </ol>
                                <p><?php echo getPageMetaByIDKeyGroup(30,'Description 2','Example 1');?></p>
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        ...
                        <div class='forexSec4-main-cont'>
                            <div>
                                <h6 class='tx-blue bld'><?php echo getPageMetaByIDKeyGroup(30,'Heading','Example 2');?></h6>
                                <ol>
                                    <?php echo getPageMetaByIDKeyGroup(30,'Description','Example 2');?>
                                </ol>
                                <p><?php echo getPageMetaByIDKeyGroup(30,'Description 2','Example 2');?></p>
                            </div>
                        </div>
                    </li>
                </ul>
                <div class='mn-btn'>
                    <a class='gd-btn marR1 signUp' href='<?php echo getPageMetaByIDKeyGroup(30,'Button URL 1','Bottom Buttons');?>'><?php echo getPageMetaByIDKeyGroup(30,'Button Text 1','Bottom Buttons');?>
                    <span>
                    ...
                    <a class='ol-btn loginUp' href='<?php echo getPageMetaByIDKeyGroup(30,'Button URL 2','Bottom Buttons');?>'><?php echo getPageMetaByIDKeyGroup(30,'Button Text 2','Bottom Buttons');?></a>
                </div>
            </div>
        </div>
    </section>

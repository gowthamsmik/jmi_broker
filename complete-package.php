            ...
            <div class='row'>
                <div class='col-md-7'>
                    <div class='banner-cont mn-hd mn-btn'>
                        ...
                        <a class='theam-btn signUp' href="<?php echo getPageMetaByIDKeyGroup(21,'Banner Button URL','Banner');?>"><?php echo getPageMetaByIDKeyGroup(21,'Banner Button Text','Banner');?> 
                            <span>
                        ...
                        <a class='ol-btn loginUp' href="<?php echo getPageMetaByIDKeyGroup(21,'Banner Button URL 2','Banner');?>"><?php echo getPageMetaByIDKeyGroup(21,'Banner Button Text 2','Banner');?></a>
                    </div>
                </div>

...
<body>
    ...
    <section class="pip-banner" style="background-image: url('cms/<?php echo getPageMetaByIDKeyGroup(24, 'Banner Background', 'Banner'); ?>');">
        <div class="container">
            <div class="banner-cont text-center mn-hd mn-btn">
                ...
                <a class="gd-btn marR1 signUp" href="<?php echo isset($_SESSION['sessionuser']) ? $demoAccountURL : getPageMetaByIDKeyGroup(24,'Banner Button URL','Banner'); ?>" ><?php echo getPageMetaByIDKeyGroup(24,'Banner Button Text','Banner');?> 
                    <span>

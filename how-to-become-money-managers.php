            ...
            <div class='partnerBannner-cont'>
               <div class='banner-cont mn-hd mn-btn <?php echo ($userPreferredLanguage === 'ru') ? 'pb-5' : ''; ?>'>
                  ...
                  <div class='banner-btn'>
                     ...
                     <a class='ol-btn <?php echo isset($_SESSION['sessionuser']) ? '' : 'signUp'; ?>' href="<?php echo isset($_SESSION['sessionuser']) ? $liveAccountURL : getPageMetaByIDKeyGroup(15, 'Banner Button URL 2','Banner'); ?>" ><?php echo getPageMetaByIDKeyGroup(15, 'Banner Button Text 2','Banner');?></a>
                  </div>
               </div>

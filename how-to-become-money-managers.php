            ...
            <div class='partnerBannner-cont'>
               <div class='banner-cont mn-hd mn-btn'>
                  ...
                  <div class='banner-btn'>
                     <a class='gd-btn signUp' href="<?php echo isset($_SESSION['sessionuser']) ? $demoAccountURL : getPageMetaByIDKeyGroup(15, 'Banner Button URL','Banner'); ?>" ><?php echo getPageMetaByIDKeyGroup(15, 'Banner Button Text','Banner');?>
                        <span>
                     ...
                     <a class='ol-btn loginUp' href="<?php echo isset($_SESSION['sessionuser']) ? $liveAccountURL : getPageMetaByIDKeyGroup(15, 'Banner Button URL 2','Banner'); ?>" ><?php echo getPageMetaByIDKeyGroup(15, 'Banner Button Text 2','Banner');?></a>
                  </div>
               </div>

               <div class='banner-img hd-pad pdT1 fs-0'>
                  <img src='cms/<?php echo getPageMetaByIDKeyGroup(15, 'Banner Background','Banner');?>' alt=''>
               </div>
            </div>
        </div>
      </section>
               ...
               <div class='row'>
                  <div class='col-md-6'>
                     <div class='mn-hd partnerSec1-cont moneySec1-cont businessSec1-cont'>
                        <h3 class='tx-blue'><?php echo getPageMetaByIDKeyGroup(15, 'Heading','Money Managers');?></h3>
                        <p class='p-fs3'><?php echo getPageMetaByIDKeyGroup(15, 'Description','Money Managers');?></p>
                     </div>
                  </div>

                  <div class='col-md-6'>
                     <div class='moneySec1-img'>
                        <img src='cms/<?php echo getPageMetaByIDKeyGroup(15, 'Image','Money Managers');?>' alt=''>
                     </div>
                  </div>
               </div>
         ...
         <div class='container'>
            <div class='pdX5'>
                  ...
                  <div class='col-md-6'>
                     <div class='mn-hd partnerSec1-cont hd-pad'>
                        <ul class='list100 ul-pd'>
                           <?php echo getPageMetaByIDKeyGroup(15, 'Description 2','Label Program');?>
                        </ul>
                     </div>
                  </div>
               </div>
               ...
               <div class='row'>
                  <div class='col-md-12'>
                     <div class='mn-hd partnerSec1-cont'>
                        <h6 class='tx-blue bld'><?php echo getPageMetaByIDKeyGroup(15, 'Heading','Depending on platform');?></h6>
                        <p class='p-fs3 tx-grey300 pe-0'><?php echo getPageMetaByIDKeyGroup(15, 'Description 1','Depending on platform');?></p>
                     </div>
                  </div>
               </div>

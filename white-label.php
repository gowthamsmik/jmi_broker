            ...
            <div class='partnerBannner-cont'>
               <div class='banner-cont mn-hd mn-btn'>
                  ...
                  <div class='banner-btn'>
                     <a class='gd-btn <?php echo isset($_SESSION['sessionuser']) ? '' : 'signUp'; ?>' href="<?php echo isset($_SESSION['sessionuser']) ? $demoAccountURL : getPageMetaByIDKeyGroup(16,'Banner Button URL','Banner'); ?>" ><?php echo getPageMetaByIDKeyGroup(16,'Banner Button Text','Banner');?>
                        <span>
                     ...
                     <a class='ol-btn <?php echo isset($_SESSION['sessionuser']) ? '' : 'signUp'; ?>' href="<?php echo isset($_SESSION['sessionuser']) ? $liveAccountURL : getPageMetaByIDKeyGroup(16,'Banner Button URL 2','Banner'); ?>" ><?php echo getPageMetaByIDKeyGroup(16,'Banner Button Text 2','Banner');?></a>
                  </div>
               </div>
